---
title: Ecosistema
description: Progetti e integrazioni costruiti con Hena Agent.
---

Una raccolta di progetti della comunità costruiti su Hena Agent.

:::note
Vuoi aggiungere il tuo progetto legato a Hena Agent a questa lista? Apri una PR.
:::
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Hena Agent in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Hena Agent con Wakatime                                                            |
...
| [oh-my-hena-agent](https://github.com/code-yeongyu/oh-my-hena-agent)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Hena Agent                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Hena Agent                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Hena Agent di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende hena-agent /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Hena Agent: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Hena Agent                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Hena Agent, costruito sull'SDK    |
...
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Hena Agent su Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Hena Agent                               |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per hena-agent: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Hena Agent tramite @hena-agent/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Hena Agent                   |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Hena Agent nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Hena Agent      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Hena Agent con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Hena Agent                |
