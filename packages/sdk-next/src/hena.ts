import { Hena } from "@hena/client/effect"
...
import { createEmbeddedRoutes } from "@hena/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Hena.create")(function* () {
  ...
  const client = yield* Hena.make({ baseUrl: "http://hena.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@hena/sdk-next/Hena") {}
