...
Desktop application and browser-based app issues, including `hena-agent web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core hena-agent server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Hena Zen, Hena Go, and billing issues.
