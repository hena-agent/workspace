...
สร้าง `.hena-agent/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Hena Agent:
...
- ระดับผู้ใช้ (Global): `~/.config/hena-agent/commands/`
- ระดับโปรเจ็กต์: `.hena-agent/commands/`
...
Hena Agent มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
