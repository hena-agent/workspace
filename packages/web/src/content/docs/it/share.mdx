---
title: Condivisione
description: Condividi le tue conversazioni Hena.
---

La funzione di condivisione di Hena ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Hena:
...
Hena supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Hena usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `hena.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare hena nella tua organizzazione.
