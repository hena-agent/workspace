export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.hena-agent.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.hena-agentGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Hena Agent.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Visite ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em hena-agent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Hena Agent este aplicativo se conecta.",
  ...
  "wsl.onboarding.step.hena-agent": "Hena Agent",
  ...
  "wsl.onboarding.checkingHenaAgent": "Verificando o Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Verificando o Hena Agent em {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Atualizando o Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Atualizando o Hena Agent em {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Atualize o Hena Agent em {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Atualizar o Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "O Hena Agent está pronto em {{distro}}.",
  "wsl.onboarding.hena-agentReady": "O Hena Agent está pronto.",
  "wsl.onboarding.installHenaAgentIn": "Instale o Hena Agent em {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Instalar o Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Hena Agent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Hena Agent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Hena Agent novamente.",
  ...
  "toast.update.description": "Uma nova versão do Hena Agent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Hena Agent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (hena-agent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Hena Agent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "Hena Agent Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Hena Agent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Hena Agent",
  ...
  "settings.general.row.appearance.description": "Personalize como o Hena Agent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Hena Agent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Hena Agent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Hena Agent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Hena Agent.",
