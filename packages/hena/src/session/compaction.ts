...
import { buildPrompt } from "@hena/core/session/compaction"
import { SessionCompactionEvent } from "@hena/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@hena/SessionCompaction") {}
