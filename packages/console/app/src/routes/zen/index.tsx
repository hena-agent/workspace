...
import compareVideo from "../../asset/lander/hena-agent-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/hena-agent-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="hena-agent:auth" content={loggedin() ? "true" : "false"} />
