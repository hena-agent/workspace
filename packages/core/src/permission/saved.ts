...
import { PermissionSaved } from "@hena-agent/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/PermissionSaved") {}
