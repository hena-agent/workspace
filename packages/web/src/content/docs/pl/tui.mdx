---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala Hena.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

hena zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie hena uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI hena, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do Hena. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `hena.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Hena czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `hena.default`.
