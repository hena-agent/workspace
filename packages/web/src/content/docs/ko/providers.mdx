...
1. TUI에서 `/connect` 명령을 실행하고 `Hena Zen`을 선택한 뒤, [hena.ai/auth](https://hena.ai/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `Hena Go`를 선택한 뒤 [hena.ai/auth](https://hena.ai/zen)로 이동하십시오.
