// Shared type vocabulary for the direct interactive mode (`hena-agent --mini`).
//
...
import type { HenaAgentClient, PermissionRequest, QuestionRequest, ToolPart } from "@hena-agent/sdk/v2"
import type { TuiConfig } from "@hena-agent/tui/config"
...
type PromptModel = Parameters<HenaAgentClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<HenaAgentClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<HenaAgentClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<HenaAgentClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<HenaAgentClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<HenaAgentClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<HenaAgentClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<HenaAgentClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<HenaAgentClient["question"]["reject"]>[0]
