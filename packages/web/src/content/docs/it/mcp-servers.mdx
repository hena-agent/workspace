...
Puoi definire server MCP nella tua [Hena Agent Config](https://hena.ai/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
