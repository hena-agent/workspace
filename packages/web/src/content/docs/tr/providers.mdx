...
1. TUI'de `/connect` komutunu çalıştırın, hena-agent'u seçin ve [hena.ai/auth](https://hena.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `Hena Go`'yu seçin ve [hena.ai/auth](https://hena.ai/zen) adresine gidin.
