export const dict = {
  ...
  "dialog.provider.hena.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.hena.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.henaGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Hena",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Hena.",
  ...
  "provider.connect.henaZen.visit.prefix": "قم بزيارة ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Hena.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في hena.json",
  ...
  "dialog.server.description": "تبديل خادم Hena الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingHena": "جارٍ التحقق من Hena...",
  "wsl.onboarding.checkingHenaIn": "جارٍ التحقق من Hena في {{distro}}...",
  "wsl.onboarding.updatingHena": "جارٍ تحديث Hena...",
  "wsl.onboarding.updatingHenaIn": "جارٍ تحديث Hena في {{distro}}...",
  "wsl.onboarding.updateHenaIn": "حدّث Hena في {{distro}}.",
  "wsl.onboarding.updateHena": "تحديث Hena",
  "wsl.onboarding.henaReadyIn": "Hena جاهز في {{distro}}.",
  "wsl.onboarding.henaReady": "Hena جاهز.",
  "wsl.onboarding.installHenaIn": "ثبّت Hena في {{distro}}.",
  "wsl.onboarding.installHena": "تثبيت Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Hena من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Hena التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Hena.",
  ...
  "toast.update.description": "نسخة جديدة من Hena ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Hena",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (hena.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Hena لا يدعم مصادقة MCP بعد.',
  ...
  "home.project.new": "مشروع جديد",
  "home.project.new.description": "ابدأ بمحادثة وأضف مجلدًا لاحقًا.",
  "home.project.openFolder": "فتح مجلد",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Hena نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Hena داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Hena",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Hena على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Hena يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Hena.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Hena",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Hena.",
