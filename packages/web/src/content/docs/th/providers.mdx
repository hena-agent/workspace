...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก hena-agent และไปที่ [hena.ai/auth](https://hena.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Hena Go` และไปที่ [hena.ai/auth](https://hena.ai/zen)
