...
يمكنك تعريف خوادم MCP في [إعدادات Hena Agent](https://hena.ai/docs/config/) ضمن `mcp`. أضف كل خادم MCP باسم فريد. ويمكنك الإشارة إلى ذلك الخادم بالاسم عند توجيه الطلب إلى الـ LLM.
