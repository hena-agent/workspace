---
title: LSP-servere
description: Hena Agent integreres med dine LSP-servere.
---

Hena Agent kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Hena Agent leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `HENA_AGENT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og hena-agent åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din hena-agent-konfiguration.
