---
title: Ecosystem
description: Projects and integrations built with Hena Agent.
---

A collection of community projects built on Hena Agent.

:::note
Want to add your Hena Agent related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Hena Agent sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Hena Agent usage with Wakatime                                                                 |
...
| [oh-my-hena-agent](https://github.com/code-yeongyu/oh-my-hena-agent)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible             |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Hena Agent sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Hena Agent context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Hena Agent agents to lazy load prompts on demand with skill discovery and injection            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend hena-agent /commands into a powerful orchestration system with granular flow control          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Hena Agent – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Hena Agent                                                           |
...
| [opencode-jfrog-plugin](https://github.com/jfrog/opencode-jfrog-plugin)                            | JFrog Plugin for seamless integration of Hena Agent users to JFrog platform                          |
| [opencode-goal-plugin](https://github.com/willytop8/Hena Agent-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Hena Agent sessions, built on the SDK       |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Hena Agent over Tailscale/VPN              |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Hena Agent plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for hena-agent - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Hena Agent via @hena-agent/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Hena Agent             |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Hena Agent in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Hena Agent |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hena Agent extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Hena Agent          |
