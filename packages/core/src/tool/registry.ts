...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@hena-agent/llm"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/ToolRegistry") {}
