export const dict = {
  ...
  "dialog.provider.hena.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.hena.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.henaGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Hena",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Hena.",
  ...
  "provider.connect.henaZen.visit.prefix": "Visite ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Hena.",
  ...
  "dialog.plugins.empty": "Plugins configurados em hena.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Hena este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingHena": "Verificando o Hena...",
  "wsl.onboarding.checkingHenaIn": "Verificando o Hena em {{distro}}...",
  "wsl.onboarding.updatingHena": "Atualizando o Hena...",
  "wsl.onboarding.updatingHenaIn": "Atualizando o Hena em {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Atualize o Hena em {{distro}}.",
  "wsl.onboarding.updateHena": "Atualizar o Hena",
  "wsl.onboarding.henaReadyIn": "O Hena está pronto em {{distro}}.",
  "wsl.onboarding.henaReady": "O Hena está pronto.",
  "wsl.onboarding.installHenaIn": "Instale o Hena em {{distro}}.",
  "wsl.onboarding.installHena": "Instalar o Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Hena possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Hena não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Hena novamente.",
  ...
  "toast.update.description": "Uma nova versão do Hena ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Hena",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (hena.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Hena ainda não suporta autenticação MCP.',
  ...
  "home.project.new": "Novo projeto",
  "home.project.new.description": "Comece com um chat. Adicione uma pasta depois.",
  "home.project.openFolder": "Abrir pasta",
  ...
  "sidebar.gettingStarted.line1": "Hena inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Hena dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Hena",
  ...
  "settings.general.row.appearance.description": "Personalize como o Hena aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Hena segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Hena é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Hena iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Hena.",
