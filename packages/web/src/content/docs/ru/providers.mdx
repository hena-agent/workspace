...
1. Запустите команду `/connect` в TUI, выберите `Hena Zen` и перейдите по адресу [hena.ai/auth](https://hena.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Hena Go` и перейдите по адресу [hena.ai/auth](https://hena.ai/zen).
