---
title: Condivisione
description: Condividi le tue conversazioni Hena Agent.
---

La funzione di condivisione di Hena Agent ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Hena Agent:

1. Crea un URL pubblico univoco per la sessione
2. Sincronizza la cronologia della conversazione sui nostri server
3. Rende la conversazione accessibile tramite il link condivisibile: `hena.dev/s/<share-id>`

---

## Condivisione

Hena Agent supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Hena Agent usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `hena-agent.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare hena-agent nella tua organizzazione.
