...
import { IconHenaAgent } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "hena-agent/session/message-v2"
import type { Message } from "hena-agent/session/message"
import type { Session } from "hena-agent/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.henaAgentVersion} data-slot="item">
                  <div data-slot="icon" title={props.messages.henaAgentName}>
                    <IconHenaAgent width={16} height={16} />
                  </div>
