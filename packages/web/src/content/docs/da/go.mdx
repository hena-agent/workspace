...
Go fungerer som enhver anden udbyder i Hena. Du abonnerer på Hena Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Hena.
:::
...
Hena Go fungerer som enhver anden udbyder i Hena.
...
Dit [model id](/docs/config/#models) i din Hena config
bruger formatet `hena-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `hena-go/kimi-k3` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Hena.
