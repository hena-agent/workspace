---
title: SDK
description: Typesikker JS-klient for Hena Agent-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Hena Agent JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Hena Agent programmatisk.
...
Opprett en forekomst av Hena Agent:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `hena-agent.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Hena Agent, kan du opprette en klientforekomst for å koble til den:
