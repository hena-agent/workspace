...
export const dict = {
  ...
  "dialog.provider.hena-agent.note": "使用 Hena Zen 或 API 密钥连接",
  "dialog.provider.hena-agent.tagline": "可靠的优化模型",
  "dialog.provider.hena-agentGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Hena Agent 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 hena-agent.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Hena Agent 服务器。",
  ...
  "wsl.onboarding.checkingHenaAgent": "正在检查 Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "正在检查 {{distro}} 中的 Hena Agent...",
  ...
  "wsl.onboarding.hena-agentReadyIn": "{{distro}} 中的 Hena Agent 已就绪。",
  "wsl.onboarding.hena-agentReady": "Hena Agent 已就绪。",
  "wsl.onboarding.installHenaAgentIn": "在 {{distro}} 中安装 Hena Agent。",
  "wsl.onboarding.installHenaAgent": "安装 Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "未安装 Hena Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Hena Agent 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Hena Agent。",
  ...
  "toast.update.description": "Hena Agent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Hena Agent 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (hena-agent.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Hena Agent 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Hena Agent 服务器。",
  ...
  "settings.general.row.language.description": "更改 Hena Agent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Hena Agent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Hena Agent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Hena Agent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Hena Agent 启动时自动检查更新",
