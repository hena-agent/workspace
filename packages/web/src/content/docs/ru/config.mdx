...
Файл конфигурации имеет схему, определенную в [**`hena.ai/config.json`**](https://hena.ai/config.json).

Конфигурация TUI использует [**`hena.ai/tui.json`**](https://hena.ai/tui.json).
