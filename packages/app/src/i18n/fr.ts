export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.hena-agent.tagline": "Modèles optimisés et fiables",
  "dialog.provider.hena-agentGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Hena Agent.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Visitez ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans hena-agent.json",
  ...
  "dialog.server.description": "Changez le serveur Hena Agent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Vérification d'Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Vérification d'Hena Agent dans {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Mise à jour d'Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Mise à jour d'Hena Agent dans {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Mettez à jour Hena Agent dans {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Mettre à jour Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent est prêt dans {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent est prêt.",
  "wsl.onboarding.installHenaAgentIn": "Installez Hena Agent dans {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Installer Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Hena Agent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Hena Agent.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Hena Agent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Hena Agent",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (hena-agent.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Hena Agent ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Hena Agent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Hena Agent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Hena Agent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Hena Agent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Hena Agent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Hena Agent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Hena Agent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Hena Agent.",
