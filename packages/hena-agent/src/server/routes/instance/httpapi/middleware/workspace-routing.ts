...
>()("@hena-agent/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@hena-agent/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.HENA_AGENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.HENA_AGENT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return (
    ...
    request.headers["x-hena-agent-directory"] ||
    process.cwd()
  )
}
