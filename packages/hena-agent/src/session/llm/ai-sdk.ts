import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@hena-agent/llm"
...
// Move this extraction into @hena-agent/llm when Copilot is handled by the native runtime.
