...
//
// The saved variant persists across sessions in ~/.local/state/hena-agent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@hena-agent/RunVariant") {}
