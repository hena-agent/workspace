export const dict = {
  ...
  "dialog.provider.hena.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.hena.tagline": "Modèles optimisés et fiables",
  "dialog.provider.henaGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Hena",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Hena.",
  ...
  "provider.connect.henaZen.line1":
    "Hena Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.henaZen.visit.prefix": "Visitez ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Hena.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans hena.json",
  ...
  "dialog.server.description": "Changez le serveur Hena auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingHena": "Vérification d'Hena...",
  "wsl.onboarding.checkingHenaIn": "Vérification d'Hena dans {{distro}}...",
  "wsl.onboarding.updatingHena": "Mise à jour d'Hena...",
  "wsl.onboarding.updatingHenaIn": "Mise à jour d'Hena dans {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Mettez à jour Hena dans {{distro}}.",
  "wsl.onboarding.updateHena": "Mettre à jour Hena",
  "wsl.onboarding.henaReadyIn": "Hena est prêt dans {{distro}}.",
  "wsl.onboarding.henaReady": "Hena est prêt.",
  "wsl.onboarding.installHenaIn": "Installez Hena dans {{distro}}.",
  "wsl.onboarding.installHena": "Installer Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Hena puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Hena n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Hena.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Hena ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Hena",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (hena.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Hena ne supporte pas encore l'authentification MCP.",
  ...
  "home.project.new": "Nouveau projet",
  "home.project.new.description": "Commencez par discuter. Ajoutez un dossier plus tard.",
  "home.project.openFolder": "Ouvrir un dossier",
  "home.project.openFolder.description": "Travaillez dans un dossier existant.",
  "home.project.name": "Nom du projet",
  "home.project.create": "Créer le projet",
  "project.mode.chat": "Projet de chat",
  "project.mode.code": "Projet de code",
  ...
  "sidebar.gettingStarted.line1":
    "Hena inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Hena dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Hena",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Hena sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Hena suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Hena.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Hena",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Hena.",
