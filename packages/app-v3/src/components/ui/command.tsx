...
function CommandRoot({ className, ...props }: ComponentProps<typeof Command>) {
  return (
    <Command
      data-slot="command"
      className={cn(
...
function CommandEmpty({ className, ...props }: ComponentProps<typeof Command.Empty>) {
  return <Command.Empty data-slot="command-empty" className={cn("py-6 text-center text-sm", className)} {...props} />
}
...
function CommandSeparator({ className, ...props }: ComponentProps<typeof Command.Separator>) {
  return (
    <Command.Separator data-slot="command-separator" className={cn("-mx-1 h-px bg-border", className)} {...props} />
  )
}

function CommandItem({ className, children, ...props }: ComponentProps<typeof Command.Item>) {
  return (
    <Command.Item
