...
import { normalizePromptContent } from "@hena-agent/tui/editor"
...
import { HENA_AGENT_BASE_MODE, useBindings } from "@hena-agent/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Hena Agent" } satisfies SlashOption,
    ]
