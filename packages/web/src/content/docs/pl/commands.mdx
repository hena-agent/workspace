...
Utwórz `.hena-agent/commands/test.md`:
...
Możesz zdefiniować polecenia w `hena-agent.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji hena-agent:
...
- Globalnie: `~/.config/hena-agent/commands/`
- Na projekt: `.hena-agent/commands/`
...
hena-agent zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
