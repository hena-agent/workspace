...
export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.hena-agent.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.hena-agentGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Hena Agent.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Besøk ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i hena-agent.json",
  ...
  "dialog.server.description": "Bytt hvilken Hena Agent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Hena Agent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Hena Agent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (hena-agent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Hena Agent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Hena Agent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Hena Agent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Hena Agent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Hena Agent skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Hena Agent er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Hena Agent starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Hena Agent.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Sjekker Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Sjekker Hena Agent i {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Oppdaterer Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Oppdaterer Hena Agent i {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Oppdater Hena Agent i {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Oppdater Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent er klar i {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent er klar.",
  "wsl.onboarding.installHenaAgentIn": "Installer Hena Agent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Hena Agent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Hena Agent på nytt.",
