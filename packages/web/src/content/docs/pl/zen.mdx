---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Hena Agent.
---
...
Hena Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Hena Agent.

Zen działa jak każdy inny dostawca w Hena Agent. Logujesz się do Hena Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Hena Agent.
:::
...
Hena Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Hena Zen działa jak każdy inny dostawca w Hena Agent.

1. Logujesz się do **<a href={console}>Hena Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Hena Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Hena Agent używa formatu
`hena-agent/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`hena-agent/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Hena Agent używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Hena Agent przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Hena Agent także dowolnego innego dostawcy.
