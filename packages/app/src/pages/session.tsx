import type { FilePart, Project, UserMessage, VcsFileDiff } from "@hena-agent/sdk/v2"
...
import type { SessionReviewLineComment } from "@hena-agent/session-ui/session-review"
import { ResizeHandle } from "@hena-agent/ui/resize-handle"
import { Select } from "@hena-agent/ui/select"
import { SelectV2 } from "@hena-agent/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@hena-agent/ui/scroll-view"
import { Tabs } from "@hena-agent/ui/tabs"
import { ButtonV2 } from "@hena-agent/ui/v2/button-v2"
import { createAutoScroll } from "@hena-agent/ui/hooks"
import { previewSelectedLines } from "@hena-agent/session-ui/pierre/selection-bridge"
import { Button } from "@hena-agent/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@hena-agent/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@hena-agent/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@hena-agent/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@hena-agent/session-ui/v2/session-review-v2"
