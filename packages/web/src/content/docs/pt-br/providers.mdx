...
1. Execute o comando `/connect` no TUI, selecione `Hena Zen` e acesse [hena.ai/zen](https://hena.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Hena Go` e acesse [hena.ai/zen](https://hena.ai/zen).
