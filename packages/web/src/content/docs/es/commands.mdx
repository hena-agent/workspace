...
Puede agregar comandos personalizados a través de la configuración Hena o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Hena [config](/docs/config):
...
hena incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
