---
title: Zen
description: Kuratierte Modellliste direkt von Hena.
---
...
Hena Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Hena-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Hena. Du meldest dich bei Hena Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Hena zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Hena funktionieren.
:::
...
Hena Zen funktioniert wie jeder andere Provider in Hena.
...
Die [Model-ID](/docs/config/#models) in deiner Hena-Konfiguration verwendet das Format `hena/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `hena/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Hena verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Hena verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Hena verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Laguna S 2.1 Free ist für begrenzte Zeit auf Hena verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Hena verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Hena verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Hena verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Hena auch jeden anderen Provider zu verwenden.
