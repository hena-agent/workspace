export const dict = {
  "app.title": "Rankingi użycia modeli AI | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny Hena Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Hena na GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Wypróbuj Hena",
  ...
  "footer.homeAria": "Strona główna Hena",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Hena.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Hena",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Hena",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Hena z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Hena Data",
  "model.description":
