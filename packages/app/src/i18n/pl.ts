export const dict = {
  ...
  "dialog.provider.hena.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.hena.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.henaGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Hena",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Hena.",
  ...
  "provider.connect.henaZen.visit.prefix": "Odwiedź ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Hena.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w hena.json",
  ...
  "dialog.server.description": "Przełącz serwer Hena, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingHena": "Sprawdzanie Hena...",
  "wsl.onboarding.checkingHenaIn": "Sprawdzanie Hena w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingHena": "Aktualizowanie Hena...",
  "wsl.onboarding.updatingHenaIn": "Aktualizowanie Hena w dystrybucji {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Zaktualizuj Hena w dystrybucji {{distro}}.",
  "wsl.onboarding.updateHena": "Zaktualizuj Hena",
  "wsl.onboarding.henaReadyIn": "Hena jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.henaReady": "Hena jest gotowy.",
  "wsl.onboarding.installHenaIn": "Zainstaluj Hena w dystrybucji {{distro}}.",
  "wsl.onboarding.installHena": "Zainstaluj Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Hena będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Hena nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Hena.",
  ...
  "toast.update.description": "Nowa wersja Hena ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Hena",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (hena.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Hena nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "home.project.new": "Nowy projekt",
  "home.project.new.description": "Zacznij od czatu. Folder możesz dodać później.",
  "home.project.openFolder": "Otwórz folder",
  ...
  "sidebar.gettingStarted.line1": "Hena zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Hena wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Hena",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Hena na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Hena ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Hena.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Hena",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Hena.",
