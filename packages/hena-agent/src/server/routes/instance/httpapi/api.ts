...
import { makeApi } from "@hena-agent/protocol/api"
import { LocationMiddleware } from "@hena-agent/server/location"
import { SessionLocationMiddleware } from "@hena-agent/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("hena-agent-root")
...
export const InstanceHttpApi = HttpApi.make("hena-agent-instance")
...
export const HenaAgentHttpApi = HttpApi.make("hena-agent")
