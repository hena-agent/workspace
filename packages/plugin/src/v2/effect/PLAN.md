...
- Effect plugins import `@hena-agent/plugin/v2/effect`, not `@hena-agent/core`.
- Public domain values use generated `@hena-agent/sdk` types.
...
- Define `PluginHost` domain capabilities in `@hena-agent/plugin/v2/effect`.
