...
export const TypeId: TypeId = "~@hena/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@hena/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@hena/effect-sqlite-node/NodeSqliteClient")
