export const dict = {
  ...
  "dialog.provider.hena-agent.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.hena-agent.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.hena-agentGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Hena Agent.",
  ...
  "provider.connect.hena-agentZen.line1":
    "يمنحك Hena Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "قم بزيارة ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Hena Agent.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في hena-agent.json",
  ...
  "dialog.server.description": "تبديل خادم Hena Agent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingHenaAgent": "جارٍ التحقق من Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "جارٍ التحقق من Hena Agent في {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "جارٍ تحديث Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "جارٍ تحديث Hena Agent في {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "حدّث Hena Agent في {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "تحديث Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent جاهز في {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent جاهز.",
  "wsl.onboarding.installHenaAgentIn": "ثبّت Hena Agent في {{distro}}.",
  "wsl.onboarding.installHenaAgent": "تثبيت Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Hena Agent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Hena Agent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Hena Agent.",
  ...
  "toast.update.description": "نسخة جديدة من Hena Agent ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Hena Agent",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (hena-agent.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Hena Agent لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Hena Agent نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Hena Agent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Hena Agent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Hena Agent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Hena Agent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Hena Agent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Hena Agent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Hena Agent.",
