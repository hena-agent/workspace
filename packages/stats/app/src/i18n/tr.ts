export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Hena Data logosu",
  ...
  "header.githubAria": "GitHub'da Hena'a yıldız ver",
  "header.github": "GitHub",
  "header.tryHena": "Hena'u dene",
  ...
  "footer.homeAria": "Hena ana sayfası",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son Hena kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Hena'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Hena kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Hena token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Hena Data",
  "model.description":
