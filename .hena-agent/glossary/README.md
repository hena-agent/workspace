...
Use this folder for locale-specific translation guidance that supplements `.hena-agent/agent/translator.md`.
...
- PR #12345: https://github.com/hena-agent/hena/pull/12345

## Do Not Translate (Locale Additions)

- `Hena Agent` (preserve casing)
