...
import compareVideo from "../../asset/lander/hena-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/hena-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="hena:auth" content={loggedin() ? "true" : "false"} />
