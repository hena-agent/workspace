...
O esquema de configuração do servidor/tempo de execução é definido em [**`hena.ai/config.json`**](https://hena.ai/config.json).

A configuração do TUI usa [**`hena.ai/tui.json`**](https://hena.ai/tui.json).
