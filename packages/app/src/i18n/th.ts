export const dict = {
  ...
  "dialog.provider.hena-agent.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.hena-agent.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.hena-agentGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Hena Agent",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.hena-agentZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.hena-agentZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Hena Agent",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Hena Agent",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน hena-agent.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Hena Agent ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingHenaAgent": "กำลังตรวจสอบ Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "กำลังตรวจสอบ Hena Agent ใน {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "กำลังอัปเดต Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "กำลังอัปเดต Hena Agent ใน {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "อัปเดต Hena Agent ใน {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "อัปเดต Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.hena-agentReady": "Hena Agent พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installHenaAgentIn": "ติดตั้ง Hena Agent ใน {{distro}}.",
  "wsl.onboarding.installHenaAgent": "ติดตั้ง Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "ยังไม่ได้ติดตั้ง Hena Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Hena Agent จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Hena Agent อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Hena Agent ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Hena Agent",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (hena-agent.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Hena Agent ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Hena Agent ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Hena Agent",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Hena Agent มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Hena Agent ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Hena Agent มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Hena Agent เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Hena Agent เวอร์ชันล่าสุด",
