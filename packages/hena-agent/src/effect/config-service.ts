 ...
 *   "@hena-agent/ServerAuthConfig",
 *   {
 *     password: Config.string("HENA_AGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("HENA_AGENT_SERVER_USERNAME").pipe(Config.withDefault("hena-agent")),
 *   },
 * ) {}
 *
