...
export class NotFoundError extends Schema.TaggedError<NotFoundError>()("ProjectAttach.NotFoundError", {
  projectID: ProjectSchema.ID,
}) {}

export class AttachError extends Schema.TaggedError<AttachError>()("ProjectAttach.AttachError", {
  projectID: ProjectSchema.ID,
...
export class RecoveryRequiredError extends Schema.TaggedError<RecoveryRequiredError>()(
