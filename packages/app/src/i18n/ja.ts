export const dict = {
  ...
  "dialog.provider.hena.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.hena.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.henaGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Henaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Henaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.henaZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.henaZen.visit.prefix": " ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してHenaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Henaで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "hena.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するHenaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingHena": "Henaを確認中...",
  "wsl.onboarding.checkingHenaIn": "{{distro}}内のHenaを確認中...",
  "wsl.onboarding.updatingHena": "Henaを更新中...",
  "wsl.onboarding.updatingHenaIn": "{{distro}}内のHenaを更新中...",
  "wsl.onboarding.updateHenaIn": "{{distro}}内のHenaを更新してください。",
  "wsl.onboarding.updateHena": "Henaを更新",
  "wsl.onboarding.henaReadyIn": "{{distro}}内のHenaの準備ができました。",
  "wsl.onboarding.henaReady": "Henaの準備ができました。",
  "wsl.onboarding.installHenaIn": "{{distro}}にHenaをインストールしてください。",
  "wsl.onboarding.installHena": "Henaをインストール",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Henaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HenaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Henaをもう一度開いてください。",
  ...
  "toast.update.description": "Henaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをHenaチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (hena.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: HenaはまだMCP認証をサポートしていません。',
  ...
  "home.project.new": "新しいプロジェクト",
  "home.project.new.description": "チャットから始めて、後でフォルダを追加できます。",
  "home.project.openFolder": "フォルダを開く",
  ...
  "sidebar.gettingStarted.line1": "Henaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でHenaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Henaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのHenaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Henaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Henaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Hena の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Hena は最新バージョンです。",
