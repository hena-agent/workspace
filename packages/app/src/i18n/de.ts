...
export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.hena-agent.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.hena-agentGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Hena Agent zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Hena Agent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Hena Agent zu nutzen.",
  ...
  "dialog.plugins.empty": "In hena-agent.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Hena Agent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Hena Agent wird geprüft...",
  "wsl.onboarding.checkingHenaAgentIn": "Hena Agent in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingHenaAgent": "Hena Agent wird aktualisiert...",
  "wsl.onboarding.updatingHenaAgentIn": "Hena Agent in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateHenaAgentIn": "Aktualisieren Sie Hena Agent in {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Hena Agent aktualisieren",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent ist in {{distro}} bereit.",
  "wsl.onboarding.hena-agentReady": "Hena Agent ist bereit.",
  "wsl.onboarding.installHenaAgentIn": "Installieren Sie Hena Agent in {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Hena Agent installieren",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Hena Agent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Hena Agent erneut.",
  ...
  "toast.update.description": "Eine neue Version von Hena Agent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Hena Agent-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (hena-agent.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Hena Agent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Hena Agent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Hena Agent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Hena Agent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Hena Agent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Hena Agent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Hena Agent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Hena Agent.",
