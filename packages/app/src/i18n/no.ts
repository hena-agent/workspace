...
export const dict = {
  ...
  "dialog.provider.hena.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.hena.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.henaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Hena",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Hena.",
  ...
  "provider.connect.henaZen.visit.prefix": "Besøk ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Hena.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i hena.json",
  ...
  "dialog.server.description": "Bytt hvilken Hena-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Hena ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Hena-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (hena.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Hena ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Hena inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Hena-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Hena",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Hena ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Hena skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Hena er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Hena starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Hena.",
  ...
  "wsl.onboarding.checkingHena": "Sjekker Hena...",
  "wsl.onboarding.checkingHenaIn": "Sjekker Hena i {{distro}}...",
  "wsl.onboarding.updatingHena": "Oppdaterer Hena...",
  "wsl.onboarding.updatingHenaIn": "Oppdaterer Hena i {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Oppdater Hena i {{distro}}.",
  "wsl.onboarding.updateHena": "Oppdater Hena",
  "wsl.onboarding.henaReadyIn": "Hena er klar i {{distro}}.",
  "wsl.onboarding.henaReady": "Hena er klar.",
  "wsl.onboarding.installHenaIn": "Installer Hena i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Hena kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Hena kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Hena på nytt.",
  ...
  "home.project.new": "Nytt prosjekt",
  "home.project.new.description": "Start med en chat. Legg til en mappe senere.",
  "home.project.openFolder": "Åpne mappe",
