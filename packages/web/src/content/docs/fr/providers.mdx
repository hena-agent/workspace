...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez hena-agent et dirigez-vous vers [hena.ai/auth](https://hena.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `Hena Go` et rendez-vous sur [hena.ai/auth](https://hena.ai/zen).
