import type { PluginContext } from "@hena-agent/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@hena-agent/sdk/v2/types"
