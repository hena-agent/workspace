...
import { Entry, FileSystem, FindInput, Match } from "@hena-agent/schema/filesystem"
export { Entry, Match, Submatch } from "@hena-agent/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/FileSystem") {}
