export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Hena Agent を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Hena Agent のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'hena-agent' コマンドを使用してください。",
