export const dict = {
  ...
  "app.meta.description": "Hena - The open source coding agent.",

  "home.title": "Hena | The open source AI coding agent",

  "temp.title": "hena | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by hena",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "hena TUI with the tokyonight theme",
  "temp.screenshot.alt": "hena TUI with tokyonight theme",
  ...
  "home.what.title": "What is Hena?",
  "home.what.body": "Hena is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Hena is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Hena does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Hena?",
  "home.faq.a1":
    "Hena is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Hena?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Hena?",
  "home.faq.a3.p1":
    "Not necessarily, Hena comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Hena also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Hena?",
  "home.faq.a4.p1":
    "Yes, Hena supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Hena in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Hena is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Hena cost?",
  "home.faq.a6":
    "Hena is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Hena open source?",
  "home.faq.a8.p1": "Yes, Hena is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Hena has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  ...
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Hena has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Hena Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Hena.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Hena can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Hena adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Hena, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Hena users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Hena, you can use Zen with any agent.",
  ...
  "go.problem.body":
    "We're focused on bringing the Hena experience to as many people as possible. Hena Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Hena or any agent.",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with hena whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select hena",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start hena and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing hena services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an hena Gateway API key",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Hena Go" as the provider in your hena configuration to use Go models.',
  ...
  "download.meta.description": "Download Hena for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Hena to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Hena works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Hena is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Hena works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Hena.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Hena | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Hena for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Hena operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Hena Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Hena Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Hena by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Hena Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.meta.description": "Hena brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Hena brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Hena | Changelog",
  "changelog.meta.description": "Hena release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Hena",
