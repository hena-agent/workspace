---
title: نظام OpenCode البيئي
description: مشاريع وتكاملات OpenCode متوافقة مع Hena.
---

مجموعة من مشاريع المجتمع المبنية لـ OpenCode والتي يمكن استخدامها مع Hena من خلال توافق OpenCode.

:::note
هل تريد إضافة مشروع من نظام OpenCode البيئي متوافق مع Hena إلى هذه القائمة؟ أرسل طلب سحب (PR).
:::
