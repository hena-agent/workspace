...
Go funciona como cualquier otro proveedor en Hena. Te suscribes a Hena Go y
...
Hena Go funciona como cualquier otro proveedor en Hena.
...
El [ID del modelo](/docs/config/#models) en tu configuración de Hena
usa el formato `hena-go/<model-id>`. Por ejemplo, para Kimi K3, usarías
`hena-go/kimi-k3` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Hena.
