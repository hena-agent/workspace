export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Hena Agent Data",
  "app.description":
    "Hena Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Hena Agent Data logosu",
  ...
  "header.githubAria": "GitHub'da Hena Agent'a yıldız ver",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Hena Agent'u dene",
  ...
  "footer.homeAria": "Hena Agent ana sayfası",
  ...
  "modal.title": "Hena Agent Bülteni",
  ...
  "home.topModelsDescription": "Hena Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Hena Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Hena Agent Data",
  "lab.description":
    "Hena Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Hena Agent kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Hena Agent'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Hena Agent kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Hena Agent token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Hena Agent Data",
  "model.description":
    "{{model}} için Hena Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Hena Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Hena Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Hena Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Hena Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Hena Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Hena Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Hena Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Hena Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Hena Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Hena Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Hena Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Hena Go token hacmine göre yakındaki modeller.",
