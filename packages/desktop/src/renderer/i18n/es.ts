export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Hena",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Hena. ¿Quieres instalarla y reiniciar?",
