export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Hena-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Hena-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'hena'.",
