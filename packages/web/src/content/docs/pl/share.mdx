---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące Hena Agent.
---

Funkcja udostępniania hena-agent umożliwia tworzenie publicznych linków do konwersacji hena-agent, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, hena-agent:

1. Tworzy unikalny publiczny adres URL sesji
2. Synchronizuje historię rozmów z naszymi serwerami
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `hena.dev/s/<share-id>`

---

## Udostępnianie

hena-agent obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie hena-agent korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `hena-agent.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu hena-agent w Twojej organizacji.
