...
Možete dodati prilagođene komande kroz Hena konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Hena [config](/docs/config):
...
- Globalno: `~/.config/hena/commands/`
- Po projektu: `.hena/commands/`
...
Hena uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
