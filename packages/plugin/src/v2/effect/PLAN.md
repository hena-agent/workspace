...
- Effect plugins import `@hena/plugin/v2/effect`, not `@hena/core`.
- Public domain values use generated `@hena/sdk` types.
...
- Define `PluginHost` domain capabilities in `@hena/plugin/v2/effect`.
