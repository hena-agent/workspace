---
title: Ecosistema de OpenCode
description: Proyectos e integraciones de OpenCode compatibles con Hena.
---

Una colección de proyectos comunitarios creados para OpenCode que se pueden usar con Hena mediante la compatibilidad con OpenCode.

:::note
¿Quieres agregar a esta lista un proyecto del ecosistema OpenCode compatible con Hena? Envíe un PR.
:::
