...
import type { Event, GlobalEvent, HenaAgentClient } from "@hena-agent/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@hena-agent/RunStreamTransport") {}
