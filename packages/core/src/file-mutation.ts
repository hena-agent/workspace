...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/FileMutation") {}

/**
 * Serialize file changes by canonical target. Conditional writes compare and
 * write under the same process-local lock so cooperating Hena Agent mutations do
