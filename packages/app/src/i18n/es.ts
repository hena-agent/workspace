export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.hena-agent.tagline": "Modelos optimizados y fiables",
  "dialog.provider.hena-agentGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Hena Agent.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Visita ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en hena-agent.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Hena Agent se conecta esta app.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Comprobando Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Comprobando Hena Agent en {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Actualizando Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Actualizando Hena Agent en {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Actualiza Hena Agent en {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Actualizar Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent está listo en {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent está listo.",
  "wsl.onboarding.installHenaAgentIn": "Instala Hena Agent en {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Instalar Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Hena Agent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Hena Agent.",
  ...
  "toast.update.description": "Una nueva versión de Hena Agent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Hena Agent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (hena-agent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Hena Agent no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Hena Agent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Hena Agent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Hena Agent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Hena Agent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Hena Agent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Hena Agent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Hena Agent.",
