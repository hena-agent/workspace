---
title: SDK
description: Cliente JS seguro em tipos para o servidor Hena.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/develop/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do hena fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o hena programaticamente.
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `hena.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do hena em execução, pode criar uma instância de cliente para se conectar a ela:
