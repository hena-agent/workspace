...
description: Lag verktøy som LLM kan kalle inn Hena Agent.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Hena Agent sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.hena-agent/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/hena-agent/tools/`.
