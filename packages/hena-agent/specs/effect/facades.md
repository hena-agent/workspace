...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/hena-agent`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy Hena Agent service removed
