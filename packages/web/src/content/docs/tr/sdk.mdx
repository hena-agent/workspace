---
title: SDK
description: hena-agent sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

hena-agent JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
hena-agent'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir hena-agent örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `hena-agent.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir hena-agent örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
