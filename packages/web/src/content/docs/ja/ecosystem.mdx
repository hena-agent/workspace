---
title: OpenCode エコシステム
description: Hena と互換性のある OpenCode のプロジェクトと統合。
---

OpenCode 向けに構築され、OpenCode 互換性を通じて Hena でも利用できるコミュニティプロジェクトのコレクション。

:::note
Hena と互換性のある OpenCode エコシステムのプロジェクトをこのリストに追加したいですか? PR を送信してください。
:::
