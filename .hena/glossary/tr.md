...
- `Hena` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `hena` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Hena` in prose, `hena` only for exact technical identifiers
...
- Avoid changing `hena` to `Hena` inside commands, URLs, package names, or code literals
