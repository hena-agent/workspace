...
import { AccountStateTable, AccountTable } from "@hena-agent/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/AccountRepo") {}
