export const dict = {
  ...
  "dialog.provider.hena.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.hena.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.henaGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Hena",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Hena.",
  ...
  "provider.connect.henaZen.visit.prefix": "Besøg ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Hena.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i hena.json",
  ...
  "dialog.server.description": "Skift hvilken Hena-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingHena": "Tjekker Hena...",
  "wsl.onboarding.checkingHenaIn": "Tjekker Hena i {{distro}}...",
  "wsl.onboarding.updatingHena": "Opdaterer Hena...",
  "wsl.onboarding.updatingHenaIn": "Opdaterer Hena i {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Opdater Hena i {{distro}}.",
  "wsl.onboarding.updateHena": "Opdater Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Hena kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Hena kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Hena igen.",
  ...
  "toast.update.description": "En ny version af Hena ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Hena-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (hena.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Hena understøtter ikke MCP-godkendelse endnu.',
  ...
  "home.project.new": "Nyt projekt",
  "home.project.new.description": "Start med en chat. Tilføj en mappe senere.",
  "home.project.openFolder": "Åbn mappe",
  ...
  "sidebar.gettingStarted.line1": "Hena inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Hena-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Hena",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Hena ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Hena følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Hena er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Hena starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Hena.",
