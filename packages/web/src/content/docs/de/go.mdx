...
Go funktioniert wie jeder andere Provider in Hena. Du abonnierst Hena Go und
...
Hena Go funktioniert wie jeder andere Provider in Hena.
...
Die [Modell-ID](/docs/config/#models) in deiner Hena Config verwendet das Format `hena-go/<model-id>`. Für Kimi K3 würdest du beispielsweise `hena-go/kimi-k3` in deiner Config verwenden.
...
4. **Keinen Lock-in-Effekt** zu haben, indem wir dir ermöglichen, auch jeden anderen Provider mit Hena zu nutzen.
