...
nix run github:hena-agent/hena           # 또는 github:hena-agent/hena 로 최신 develop 브랜치
```
...
[agents](https://hena.dev/docs/agents) 에 대해 더 알아보세요.
...
**커뮤니티에 참여하기** [Discord](https://hena.dev/discord) | [X.com](https://hena.dev)
