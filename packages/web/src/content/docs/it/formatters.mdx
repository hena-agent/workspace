---
title: Formattatori
description: Hena Agent usa formattatori specifici per linguaggio.
---

Hena Agent formatta automaticamente i file dopo che vengono scritti o modificati usando formattatori specifici per linguaggio. Questo assicura che il codice generato segua lo stile del tuo progetto.

---

## Integrati

Hena Agent include diversi formattatori integrati per linguaggi e framework popolari. Qui sotto trovi la lista dei formattatori, delle estensioni supportate e dei comandi o opzioni di config richiesti.
...
Quindi, se il progetto ha `prettier` in `package.json`, Hena Agent lo usera automaticamente.

---

## Come funziona

Quando Hena Agent scrive o modifica un file:
...
Puoi personalizzare i formattatori nella sezione `formatter` della config di Hena Agent.
