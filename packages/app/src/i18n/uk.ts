export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.hena-agent.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.hena-agentGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Hena Agent.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Відвідайте ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Hena Agent.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в hena-agent.json",
  ...
  "dialog.server.description": "Перемкніть сервер Hena Agent, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Перевірка Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Перевірка Hena Agent у {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Оновлення Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Оновлення Hena Agent у {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Оновіть Hena Agent у {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Оновити Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent готовий до роботи у {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent готовий до роботи.",
  "wsl.onboarding.installHenaAgentIn": "Встановіть Hena Agent у {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Встановити Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Hena Agent потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Hena Agent.",
  ...
  "toast.update.description": "Нова версія Hena Agent ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Hena Agent",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (hena-agent.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Hena Agent ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Hena Agent всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Hena Agent",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Hena Agent на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Hena Agent використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Hena Agent.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Hena Agent",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Hena Agent.",
