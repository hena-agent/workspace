...
description: hena-agent dile özgü biçimlendiriciler kullanır.
---

hena-agent, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

hena-agent, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, hena-agent bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

hena-agent bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri hena-agent yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
