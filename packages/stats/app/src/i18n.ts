...
const en = {
  "app.title": "AI Model Usage Rankings | Hena Agent Data",
  "app.description":
    "Explore Hena Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Hena Agent Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Hena Agent on GitHub",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Try Hena Agent",
  ...
  "footer.homeAria": "Hena Agent home",
  ...
  "home.topModelsDescription": "Usage of models across Hena Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Hena Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Hena Agent Data",
  "lab.description":
    "Compare {{lab}} models used in Hena Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Hena Agent usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Hena Agent",
  ...
  "lab.shareOfUsage": "{{share}} of recent Hena Agent usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Hena Agent Data",
  "model.description":
    "View {{model}} Hena Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Hena Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Hena Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Hena Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Hena Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Hena Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Hena Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Hena Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Hena Go token volume.",
