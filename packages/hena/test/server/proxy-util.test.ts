...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips Hena internal headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-hena-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-hena-directory")).toBeNull()
      expect(result.get("x-hena-workspace")).toBeNull()
