...
import { Slug } from "@hena-agent/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@hena-agent/llm"
...
import { locationServiceMapLayer } from "@hena-agent/core/location-services"
...
import { PartTable, SessionTable } from "@hena-agent/core/session/sql"
...
import { NonNegativeInt, optional } from "@hena-agent/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".hena-agent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/Session") {}
