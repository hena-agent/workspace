...
import { openEditor } from "@hena/tui/editor"
import { registerHenaKeymap } from "@hena/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerHenaKeymap(keymap, renderer, input.tuiConfig)
