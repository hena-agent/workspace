...
Generates UPCOMING_CHANGELOG.md by running the Hena Agent changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for hena-agent run (default: low)
      --quiet            Suppress Hena Agent command output unless it fails
