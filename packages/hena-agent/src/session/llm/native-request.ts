import type { JsonSchema, LLMRequest, ProviderMetadata } from "@hena-agent/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@hena-agent/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @hena-agent/llm request objects from Hena Agent's session/AI SDK-shaped data.
  return LLM.request({
