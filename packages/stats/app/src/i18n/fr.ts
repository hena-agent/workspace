export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Hena Agent Data",
  "app.description":
    "Explorez l'utilisation d'Hena Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel Hena Agent Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Hena Agent sur GitHub",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Essayer Hena Agent",
  ...
  "footer.homeAria": "Accueil Hena Agent",
  ...
  "modal.title": "Newsletter Hena Agent",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Hena Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Hena Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Hena Agent Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Hena Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Hena Agent.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Hena Agent",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Hena Agent",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Hena Agent sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Hena Agent Data",
  "model.description":
    "Consultez les données d'utilisation Hena Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Hena Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Hena Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Hena Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Hena Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Hena Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Hena Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Hena Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Hena Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Hena Go.",
  ...
  "model.geoDescription": "Tokens du modèle Hena Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Hena Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Hena Go.",
