...
export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.hena-agent.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.hena-agentGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Hena Agent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Hena Agent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Hena Agent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Hena Agent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler hena-agent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Hena Agent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Hena Agent kontrol ediliyor...",
  "wsl.onboarding.checkingHenaAgentIn": "{{distro}} içinde Hena Agent kontrol ediliyor...",
  "wsl.onboarding.updatingHenaAgent": "Hena Agent güncelleniyor...",
  "wsl.onboarding.updatingHenaAgentIn": "{{distro}} içinde Hena Agent güncelleniyor...",
  "wsl.onboarding.updateHenaAgentIn": "{{distro}} içindeki Hena Agent'u güncelleyin.",
  "wsl.onboarding.updateHenaAgent": "Hena Agent'u güncelle",
  "wsl.onboarding.hena-agentReadyIn": "{{distro}} içinde Hena Agent hazır.",
  "wsl.onboarding.hena-agentReady": "Hena Agent hazır.",
  "wsl.onboarding.installHenaAgentIn": "Hena Agent'u {{distro}} içine kurun.",
  "wsl.onboarding.installHenaAgent": "Hena Agent'u kur",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Hena Agent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Hena Agent'u tekrar açın.",
  ...
  "toast.update.description": "Hena Agent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Hena Agent ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (hena-agent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Hena Agent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Hena Agent Masaüstü",
  ...
  "settings.desktop.wsl.description": "Hena Agent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Hena Agent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Hena Agent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Hena Agent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Hena Agent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Hena Agent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Hena Agent'un en son sürümünü kullanıyorsunuz.",
