---
title: Compartir
description: Comparte tus conversaciones Hena Agent.
---

La función para compartir de Hena Agent te permite crear enlaces públicos a tus conversaciones de Hena Agent, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Hena Agent:

1. Crea una URL pública única para su sesión.
2. Sincroniza tu historial de conversaciones con nuestros servidores
3. Hace que la conversación sea accesible a través del enlace para compartir: `hena.dev/s/<share-id>`

---

## Uso compartido

Hena Agent admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Hena Agent usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `hena-agent.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de hena-agent en su organización.
