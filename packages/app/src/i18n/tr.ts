...
export const dict = {
  ...
  "dialog.provider.hena.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.hena.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.henaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Hena tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Hena'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.henaZen.visit.prefix": "",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Hena'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Hena'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler hena.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Hena sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingHena": "Hena kontrol ediliyor...",
  "wsl.onboarding.checkingHenaIn": "{{distro}} içinde Hena kontrol ediliyor...",
  "wsl.onboarding.updatingHena": "Hena güncelleniyor...",
  "wsl.onboarding.updatingHenaIn": "{{distro}} içinde Hena güncelleniyor...",
  "wsl.onboarding.updateHenaIn": "{{distro}} içindeki Hena'u güncelleyin.",
  "wsl.onboarding.updateHena": "Hena'u güncelle",
  "wsl.onboarding.henaReadyIn": "{{distro}} içinde Hena hazır.",
  "wsl.onboarding.henaReady": "Hena hazır.",
  "wsl.onboarding.installHenaIn": "Hena'u {{distro}} içine kurun.",
  "wsl.onboarding.installHena": "Hena'u kur",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Hena'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Hena bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Hena'u tekrar açın.",
  ...
  "toast.update.description": "Hena'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Hena ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (hena.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Hena henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "home.project.new": "Yeni proje",
  "home.project.new.description": "Sohbetle başlayın. Daha sonra klasör ekleyin.",
  "home.project.openFolder": "Klasör aç",
  ...
  "sidebar.gettingStarted.line1": "Hena ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Hena Masaüstü",
  ...
  "settings.desktop.wsl.description": "Hena sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Hena'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Hena'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Hena'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Hena'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Hena başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Hena'un en son sürümünü kullanıyorsunuz.",
