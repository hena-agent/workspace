...
import { McpEvent } from "@hena/schema/mcp-event"
...
function createClient(directory: string) {
  const client = new Client({ name: "hena", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@hena/MCP") {}
