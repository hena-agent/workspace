...
import { DatabaseMigration } from "@hena-agent/core/database/migration"
import { migrations } from "@hena-agent/core/database/migration.gen"
import sessionUsageMigration from "@hena-agent/core/database/migration/20260510033149_session_usage"
import normalizeStoragePathsMigration from "@hena-agent/core/database/migration/20260601010001_normalize_storage_paths"
import sessionMessageProjectionOrderMigration from "@hena-agent/core/database/migration/20260603040000_session_message_projection_order"
import eventSourcedSessionInputMigration from "@hena-agent/core/database/migration/20260604172448_event_sourced_session_input"
import contextEpochAgentMigration from "@hena-agent/core/database/migration/20260605042240_add_context_epoch_agent"
import simplifyIntegrationCredentialsMigration from "@hena-agent/core/database/migration/20260611192811_lush_chimera"
import simplifySessionInputMigration from "@hena-agent/core/database/migration/20260622202450_simplify_session_input"
...
import { SessionSchema } from "@hena-agent/core/session/schema"
import { SessionTable } from "@hena-agent/core/session/sql"
import sessionMetadataMigration from "@hena-agent/core/database/migration/20260511173437_session-metadata"
