...
- PR #10018: https://github.com/hena-agent/hena/pull/10018
- PR #12935: https://github.com/hena-agent/hena/pull/12935

## Do Not Translate (Locale Additions)

- `Hena Agent` (preserve casing in prose; keep `hena-agent` only in commands, package names, paths, or code)
- `Hena Agent CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
