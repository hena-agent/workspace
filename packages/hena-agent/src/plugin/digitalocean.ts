import type { Hooks, PluginInput } from "@hena-agent/plugin"
import type { Model } from "@hena-agent/sdk/v2"
import { InstallationVersion } from "@hena-agent/core/installation/version"
import { OauthCallbackPage } from "@hena-agent/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Hena Agent will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
