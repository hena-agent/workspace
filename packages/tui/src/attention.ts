...
import defaultSoundPath from "@hena-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@hena-agent/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@hena-agent/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@hena-agent/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@hena-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@hena-agent/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "Hena Agent"
const DEFAULT_PACK_ID = "hena-agent.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Hena Agent Default",
  builtin: true,
  sounds: {
