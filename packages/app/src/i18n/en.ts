export const dict = {
  ...
  "dialog.provider.hena.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.hena.tagline": "Reliable optimized models",
  "dialog.provider.henaGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Hena",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Hena.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.henaZen.line1":
    "Hena Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.henaZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.henaZen.visit.prefix": "Visit ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Hena.",
  ...
  "dialog.plugins.empty": "Plugins configured in hena.json",
  ...
  "dialog.server.description": "Switch which Hena server this app connects to.",
  ...
  "wsl.onboarding.checkingHena": "Checking Hena...",
  "wsl.onboarding.checkingHenaIn": "Checking Hena in {{distro}}...",
  "wsl.onboarding.updatingHena": "Updating Hena...",
  "wsl.onboarding.updatingHenaIn": "Updating Hena in {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Update Hena in {{distro}}.",
  "wsl.onboarding.updateHena": "Update Hena",
  "wsl.onboarding.henaReadyIn": "Hena is ready in {{distro}}.",
  "wsl.onboarding.henaReady": "Hena is ready.",
  "wsl.onboarding.installHenaIn": "Install Hena in {{distro}}.",
  "wsl.onboarding.installHena": "Install Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Hena can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Hena could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Hena.",
  ...
  "dialog.project.create.title": "Start a chat",
  "dialog.project.create.name": "What are you working on?",
  "dialog.project.create.name.placeholder": "Research, planning, or anything else",
  "dialog.project.create.description": "Start without a folder. You can attach one later if you need it.",
  "dialog.project.create.submit": "Start chatting",
  "dialog.project.attach.title": "Attach folder",
  "dialog.project.attach.description":
    "Attaching a folder to {{project}} switches all existing chats in this project to coding mode.",
  "dialog.project.attach.warning": "The folder cannot be replaced or removed later.",
  ...
  "toast.update.description": "A new version of Hena ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Hena team",
  ...
  "error.chain.checkConfig": "Check your config (hena.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Hena does not support MCP authentication yet.',
  ...
  "home.project.openFolder": "Open folder...",
  "home.project.startChat": "Start a chat",
  "home.project.attachFolder": "Attach folder",
  ...
  "sidebar.gettingStarted.line1": "Hena includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Hena server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Hena",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Hena looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Hena follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Hena is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Hena launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Hena.",
