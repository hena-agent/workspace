...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HENA_AGENT_CALLER", () => {
    process.env["HENA_AGENT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HENA_AGENT_CALLER", () => {
    process.env["HENA_AGENT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HENA_AGENT_CALLER", () => {
    process.env["HENA_AGENT_CALLER"] = "unknown"
