---
title: Teilen
description: Teile Hena-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Hena-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Hena Folgendes:
...
Hena hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Hena den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`hena.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du hena in deiner Organisation einsetzt.
