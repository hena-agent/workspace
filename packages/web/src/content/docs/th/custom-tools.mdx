...
description: สร้างเครื่องมือที่ LLM สามารถเรียกใช้ใน hena-agent
---

เครื่องมือแบบกำหนดเองคือฟังก์ชันที่คุณสร้างขึ้นซึ่ง LLM สามารถเรียกใช้ระหว่างการสนทนาได้ โดยทำงานร่วมกับ [เครื่องมือในตัว](/docs/tools) ของ hena-agent เช่น `read`, `write` และ `bash`
...
- ภายในเครื่องโดยวางไว้ในไดเรกทอรี `.hena-agent/tools/` ของโครงการของคุณ
- หรือทั่วโลกโดยวางไว้ที่ `~/.config/hena-agent/tools/`
