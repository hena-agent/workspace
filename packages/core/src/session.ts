...
export class AttachError extends Schema.TaggedError<AttachError>()("Session.AttachError", {
...
export class Service extends Context.Service<Service, Interface>()("@hena/v2/Session") {}
