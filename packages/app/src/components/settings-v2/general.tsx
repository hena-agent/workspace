...
import { Switch } from "@hena-agent/ui/v2/switch-v2"
import { TextInputV2 } from "@hena-agent/ui/v2/text-input-v2"
import { useTheme, type ColorScheme } from "@hena-agent/ui/theme/context"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_HENA_AGENT_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://hena.ai/docs/themes/">
