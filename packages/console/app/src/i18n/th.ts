...
export const dict = {
  ...
  "go.title": "Hena Go | โมเดลเขียนโค้ดราคาประหยัดสำหรับทุกคน",
  ...
  "zen.api.error.trialEnded":
    "โปรโมชันฟรีสำหรับ {{model}} สิ้นสุดแล้ว คุณสามารถใช้โมเดลต่อได้โดยสมัครสมาชิก Hena Go - {{link}}",

  "black.meta.title": "Hena Black | เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.meta.description": "เข้าถึง Claude, GPT, Gemini และอื่นๆ ด้วยแผนสมาชิก Hena Black",
  "black.hero.title": "เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.hero.subtitle": "รวมถึง Claude, GPT, Gemini และอื่นๆ อีกมากมาย",
  "black.title": "Hena Black | ราคา",
  ...
  "black.workspace.title": "Hena Black | เลือก Workspace",
  "black.workspace.selectPlan": "เลือก Workspace สำหรับแผนนี้",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "สมัครสมาชิก Hena Black",
  ...
  "black.subscribe.success.title": "คุณอยู่ในรายชื่อรอ Hena Black แล้ว",
  ...
  "workspace.black.subscription.message": "คุณสมัครสมาชิก Hena Black ในราคา ${{plan}} ต่อเดือน",
  ...
  "workspace.black.waitlist.joined": "คุณอยู่ในรายชื่อรอสำหรับแผน Hena Black ราคา ${{plan}} ต่อเดือน",
  "workspace.black.waitlist.ready": "เราพร้อมที่จะลงทะเบียนให้คุณเข้าสู่แผน Hena Black ราคา ${{plan}} ต่อเดือนแล้ว",
  ...
  "workspace.lite.subscription.message": "คุณได้สมัครสมาชิก Hena Go แล้ว",
  ...
  "workspace.lite.black.message":
    "ขณะนี้คุณสมัครสมาชิก Hena Black หรืออยู่ในรายการรอ โปรดยกเลิกการสมัครก่อนหากต้องการเปลี่ยนไปใช้ Go",
  "workspace.lite.other.message":
    "สมาชิกคนอื่นใน Workspace นี้ได้สมัคร Hena Go แล้ว สามารถสมัครได้เพียงหนึ่งคนต่อหนึ่ง Workspace เท่านั้น",
  "workspace.lite.promo.description":
    "Hena Go เริ่มต้นที่ {{price}} จากนั้น $10/เดือน และมอบการเข้าถึงโมเดลการเขียนโค้ดแบบเปิดยอดนิยมอย่างเสถียรพร้อมขีดจำกัดการใช้งานที่ให้มาอย่างเหลือเฟือ",
