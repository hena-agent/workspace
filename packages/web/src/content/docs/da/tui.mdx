---
title: TUI
description: Brug af Hena Agent-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Hena Agent giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Hena Agent starter TUI for den nuværende mappe.
...
Når du bruger Hena Agent TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Hena Agent. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Hena Agent. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `hena-agent.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Hena Agent venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `hena-agent.default`.
