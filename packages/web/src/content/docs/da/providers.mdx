...
1. Kør kommandoen `/connect` i TUI, vælg hena-agent og gå til [hena.ai/auth](https://hena.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Hena Go`, og gå til [hena.ai/auth](https://hena.ai/zen).
