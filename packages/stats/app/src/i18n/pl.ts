export const dict = {
  "app.title": "Rankingi użycia modeli AI | Hena Agent Data",
  "app.description":
    "Przeglądaj użycie Hena Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Hena Agent Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Hena Agent na GitHub",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Wypróbuj Hena Agent",
  ...
  "footer.homeAria": "Strona główna Hena Agent",
  ...
  "home.topModelsDescription": "Użycie modeli w Hena Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Hena Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Hena Agent Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Hena Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Hena Agent.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Hena Agent",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Hena Agent",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Hena Agent z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Hena Agent Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Hena Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Hena Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Hena Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Hena Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Hena Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Hena Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Hena Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Hena Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Hena Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Hena Go.",
  ...
  "model.geoDescription": "Tokeny modelu Hena Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Hena Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Hena Go.",
