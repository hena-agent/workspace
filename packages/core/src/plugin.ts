...
import type { Plugin as PluginRuntime } from "@hena-agent/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/Plugin") {}
