...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HENA_CALLER", () => {
    process.env["HENA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HENA_CALLER", () => {
    process.env["HENA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HENA_CALLER", () => {
    process.env["HENA_CALLER"] = "unknown"
