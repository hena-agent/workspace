...
Konfiguracijski fajl ima šemu koja je definirana u [**`hena.ai/config.json`**](https://hena.ai/config.json).

TUI konfiguracija koristi [**`hena.ai/tui.json`**](https://hena.ai/tui.json).
