...
Brug den til at bygge integrasjoner og kontrollere hena-agent programmatisk.
...
Opret en forekomst av hena-agent:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `hena-agent.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av hena-agent, kan du oprete en klientforekomst for at koble til den:
