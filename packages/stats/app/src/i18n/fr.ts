export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel Hena Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Hena sur GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Essayer Hena",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Hena.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Hena",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Hena",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Hena sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Hena Data",
  "model.description":
