...
Generates UPCOMING_CHANGELOG.md by running the Hena changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for hena run (default: low)
      --quiet            Suppress Hena command output unless it fails
