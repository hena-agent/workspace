...
1. Uruchom polecenie `/connect` w TUI, wybierz `Hena Zen` i przejdź do [hena.ai/auth](https://hena.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Hena Go` i przejdź do [hena.ai/auth](https://hena.ai/zen).
