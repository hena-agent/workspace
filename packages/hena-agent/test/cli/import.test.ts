...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://hena.ai/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://hena.ai/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://hena.ai/share/")).toBeNull()
  expect(parseShareUrl("https://hena.ai/share/id/extra")).toBeNull()
