...
Možete definirati MCP servere u vašoj [Hena Agent Config](https://hena.ai/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
