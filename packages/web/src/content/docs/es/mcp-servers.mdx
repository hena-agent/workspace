...
Puede definir servidores MCP en su [Hena Agent Config](https://hena.ai/docs/config/) en `mcp`. Agregue cada MCP con un nombre único. Puede referirse a ese MCP por su nombre cuando solicite el LLM.
