...
- `Hena` (preserve casing in prose; keep `hena` only when it is part of commands, package names, paths, or code)
- `Hena Zen`
- `Hena CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `hena` in prose when referring to the product name; use `Hena`
