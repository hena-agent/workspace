---
title: Экосистема
description: Проекты и интеграции, созданные с помощью Hena Agent.
---

Коллекция проектов сообщества, построенных на Hena Agent.

:::note
Хотите добавить свой проект, связанный с Hena Agent, в этот список? Разместите PR.
:::
...
| Имя                                                                                                | Описание                                                                                                                                         |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Автоматически запускайте сеансы Hena Agent в изолированных песочницах Daytona с синхронизацией git и предварительным просмотром в реальном времени |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Отслеживайте использование Hena Agent с помощью Wakatime                                                                                           |
...
| [oh-my-hena-agent](https://github.com/code-yeongyu/oh-my-hena-agent)                                   | Фоновые агенты, встроенные инструменты LSP/AST/MCP, курируемые агенты, совместимость с Claude Code                                               |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Уведомления на рабочем столе и звуковые оповещения для сеансов Hena Agent                                                                          |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Автоматическое именование сеансов Zellij на основе искусственного интеллекта на основе контекста Hena Agent                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Разрешить агентам Hena Agent отложенную загрузку подсказок по требованию с обнаружением и внедрением навыков                                       |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Расширьте hena-agent/команды до мощной системы оркестровки с детальным управлением потоком данных                                                  |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Встроенные уведомления ОС для Hena Agent – узнайте, когда задачи завершены                                                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Рабочие деревья git с нулевым трением для Hena Agent                                                                                               |
...
| Имя                                                                                        | Описание                                                                                      |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-бот для управления сеансами Hena Agent, созданный на базе SDK                           |
...
| [portal](https://github.com/hosenur/portal)                                                | Мобильный веб-интерфейс для Hena Agent через Tailscale/VPN                                      |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Шаблон для создания плагинов Hena Agent                                                         |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Интерфейс Neovim для Hena Agent - агент кодирования искусственного интеллекта на базе терминала |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Поставщик Vercel AI SDK для использования Hena Agent через @hena-agent/sdk                     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Веб-приложение или настольное приложение и расширение VS Code для Hena Agent                    |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Плагин Obsidian, встраивающий Hena Agent в пользовательский интерфейс Obsidian                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Альтернатива Claude Cowork с открытым исходным кодом на базе Hena Agent                         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Менеджер расширений Hena Agent с переносимыми изолированными профилями                          |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Настольное, веб-, мобильное и удаленное клиентское приложение для Hena Agent                    |
