---
title: Deling
description: Del dine Hena Agent-samtaler.
---

Delingsfunksjonen i Hena Agent lar deg lage offentlige lenker til dine Hena Agent-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Hena Agent:

1. Oppretter en unik offentlig URL for økten din
2. Synkroniserer samtaleloggen din til serverne våre
3. Gjør samtalen tilgjengelig via den delbare lenken — `hena.dev/s/<share-id>`

---

## Deling

Hena Agent støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Hena Agent manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `hena-agent.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av hena-agent i organisasjonen din.
