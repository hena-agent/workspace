---
title: Dijeljenje
description: Dijelite Hena Agent razgovore javnim linkovima.
---

Hena Agent opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Hena Agent:

1. Kreira jedinstveni javni URL za vasu sesiju
2. Sinhronizuje historiju razgovora na nase servere
3. Cini razgovor dostupnim preko linka za dijeljenje — `hena.dev/s/<share-id>`

---

## Dijeljenje

Hena Agent podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Hena Agent koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `hena-agent.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju hena-agent u organizaciji.
