...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips Hena Agent internal headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-hena-agent-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-hena-agent-directory")).toBeNull()
      expect(result.get("x-hena-agent-workspace")).toBeNull()
