export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo Hena Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Hena su GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Prova Hena",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Hena.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Hena",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Hena",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Hena negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Hena Data",
  "model.description":
