export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.hena-agent.tagline": "Надежные оптимизированные модели",
  "dialog.provider.hena-agentGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Hena Agent.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Посетите ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Hena Agent.",
  ...
  "dialog.plugins.empty": "Плагины настроены в hena-agent.json",
  ...
  "dialog.server.description": "Переключите сервер Hena Agent к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Проверка Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Проверка Hena Agent в {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Обновление Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Обновление Hena Agent в {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Обновите Hena Agent в {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Обновить Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent в {{distro}} готов к работе.",
  "wsl.onboarding.hena-agentReady": "Hena Agent готов к работе.",
  "wsl.onboarding.installHenaAgentIn": "Установите Hena Agent в {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Установить Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Hena Agent требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Hena Agent.",
  ...
  "toast.update.description": "Новая версия Hena Agent ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Hena Agent",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (hena-agent.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Hena Agent пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Hena Agent внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Hena Agent",
  ...
  "settings.general.row.appearance.description": "Настройте как Hena Agent выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Hena Agent системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Hena Agent.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Hena Agent",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Hena Agent.",
