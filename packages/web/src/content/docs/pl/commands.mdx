...
Możesz zdefiniować polecenia w `hena.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji hena:
...
- Globalnie: `~/.config/hena/commands/`
- Na projekt: `.hena/commands/`
...
hena zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
