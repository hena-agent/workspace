...
export const dict = {
  ...
  "dialog.provider.hena-agent.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.hena-agent.tagline": "可靠的優化模型",
  "dialog.provider.hena-agentGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Hena Agent 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.hena-agentZen.line1": "Hena Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.hena-agentZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.hena-agentZen.visit.prefix": "造訪 ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Hena Agent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 hena-agent.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Hena Agent 伺服器。",
  ...
  "wsl.onboarding.checkingHenaAgent": "正在檢查 Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "正在檢查 {{distro}} 中的 Hena Agent...",
  "wsl.onboarding.updatingHenaAgent": "正在更新 Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "正在更新 {{distro}} 中的 Hena Agent...",
  "wsl.onboarding.updateHenaAgentIn": "更新 {{distro}} 中的 Hena Agent。",
  "wsl.onboarding.updateHenaAgent": "更新 Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "{{distro}} 中的 Hena Agent 已就緒。",
  "wsl.onboarding.hena-agentReady": "Hena Agent 已就緒。",
  "wsl.onboarding.installHenaAgentIn": "在 {{distro}} 中安裝 Hena Agent。",
  "wsl.onboarding.installHenaAgent": "安裝 Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "未安裝 Hena Agent",
  ...
  "wsl.onboarding.wslUnavailable.description": "Hena Agent 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Hena Agent。",
  ...
  "toast.update.description": "Hena Agent 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Hena Agent 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (hena-agent.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Hena Agent 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Hena Agent 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Hena Agent 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Hena Agent 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Hena Agent 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Hena Agent 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Hena Agent 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Hena Agent。",
