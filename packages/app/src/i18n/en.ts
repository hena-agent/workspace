export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.hena-agent.tagline": "Reliable optimized models",
  "dialog.provider.hena-agentGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Hena Agent.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Visit ",
  "provider.connect.hena-agentZen.visit.link": "hena.dev/zen",
  "provider.connect.hena-agentZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins configured in hena-agent.json",
  ...
  "dialog.server.description": "Switch which Hena Agent server this app connects to.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Checking Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Checking Hena Agent in {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Updating Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Updating Hena Agent in {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Update Hena Agent in {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Update Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent is ready in {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent is ready.",
  "wsl.onboarding.installHenaAgentIn": "Install Hena Agent in {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Install Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Hena Agent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Hena Agent.",
  ...
  "toast.update.description": "A new version of Hena Agent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Hena Agent team",
  ...
  "error.chain.checkConfig": "Check your config (hena-agent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Hena Agent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Hena Agent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Hena Agent",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Hena Agent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Hena Agent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Hena Agent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Hena Agent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Hena Agent.",
