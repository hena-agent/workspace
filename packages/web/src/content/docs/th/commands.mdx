...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Hena:
...
- ระดับผู้ใช้ (Global): `~/.config/hena/commands/`
- ระดับโปรเจ็กต์: `.hena/commands/`
...
Hena มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
