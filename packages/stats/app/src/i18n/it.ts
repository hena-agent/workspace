export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Hena Agent Data",
  "app.description":
    "Esplora l'utilizzo di Hena Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Hena Agent Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Hena Agent su GitHub",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Prova Hena Agent",
  ...
  "footer.homeAria": "Home Hena Agent",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Hena Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Hena Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Hena Agent Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Hena Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Hena Agent.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Hena Agent",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Hena Agent",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Hena Agent negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Hena Agent Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Hena Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Hena Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Hena Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Hena Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Hena Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Hena Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Hena Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Hena Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Hena Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Hena Go.",
  ...
  "model.geoDescription": "Token del modello Hena Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Hena Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Hena Go.",
