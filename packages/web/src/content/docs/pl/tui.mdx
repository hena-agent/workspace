---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala Hena Agent.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

hena-agent zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie hena-agent uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI hena-agent, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do Hena Agent. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij Hena Agent. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `hena-agent.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Hena Agent czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `hena-agent.default`.
