...
export const dict = {
  ...
  "go.title": "Hena Go | Kostengünstige Coding-Modelle für alle",
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du Hena Go abonnierst - {{link}}",

  "black.meta.title": "Hena Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit Hena Black Abos.",
  ...
  "black.subscribe.success.title": "Du bist auf der Hena Black Warteliste",
  ...
  "workspace.black.subscription.message": "Du hast Hena Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat Hena Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat Hena Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast Hena Go abonniert.",
  ...
  "workspace.lite.black.message":
    "Du hast derzeit Hena Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat Hena Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "Hena Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
