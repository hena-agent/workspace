---
title: OpenCode-Ökosystem
description: OpenCode-Projekte und -Integrationen, die mit Hena kompatibel sind.
---

Eine Sammlung von Community-Projekten für OpenCode, die dank OpenCode-Kompatibilität mit Hena verwendet werden können.

:::note
Möchten Sie ein mit Hena kompatibles OpenCode-Ökosystemprojekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::
