...
const tableBucketName = `hena-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `hena-${$app.stage}-lake-ingest`,
    destination: "iceberg",
