---
title: Deling
description: Del dine Hena-samtaler.
---

Delingsfunksjonen i Hena lar deg lage offentlige lenker til dine Hena-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Hena støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Hena manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `hena.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av hena i organisasjonen din.
