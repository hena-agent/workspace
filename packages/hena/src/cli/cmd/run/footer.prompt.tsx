...
import { normalizePromptContent } from "@hena/tui/editor"
...
import { HENA_BASE_MODE, useBindings } from "@hena/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Hena" } satisfies SlashOption,
    ]
