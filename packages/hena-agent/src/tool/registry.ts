...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@hena-agent/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.henaAgent || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/ToolRegistry") {}
