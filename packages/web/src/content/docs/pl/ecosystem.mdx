---
title: Ekosystem OpenCode
description: Projekty i integracje OpenCode zgodne z Hena.
---

Zbiór projektów społeczności stworzonych dla OpenCode, których można używać z Hena dzięki zgodności z OpenCode.

:::note
Chcesz dodać do tej listy projekt ekosystemu OpenCode zgodny z Hena? Prześlij PR.
:::
