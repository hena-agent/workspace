...
export class InvalidRepositoryError extends Schema.TaggedError<InvalidRepositoryError>()(
...
export class Service extends Context.Service<Service, Interface>()("@hena/RepositoryCache") {}
