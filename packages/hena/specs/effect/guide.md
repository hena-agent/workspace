...
How we write Effect code in `packages/hena`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@hena/Foo") {}
...
Read Hena runtime flags through
