...
1. شغّل الأمر `/connect` في TUI، واختر hena-agent، ثم انتقل إلى [hena.ai/auth](https://hena.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Hena Go`، ثم انتقل إلى [hena.ai/auth](https://hena.ai/zen).
