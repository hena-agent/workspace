...
description: OpenCode-prosjekter og integrasjoner som er kompatible med Hena.
---

En samling fellesskapsprosjekter laget for OpenCode som kan brukes med Hena gjennom OpenCode-kompatibilitet.

:::note
Vil du legge til et OpenCode-økosystemprosjekt som er kompatibelt med Hena? Send inn en PR.
:::
