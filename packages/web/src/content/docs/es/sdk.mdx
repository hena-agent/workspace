---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor Hena.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/develop/packages/sdk/js/src/gen/types.gen.ts`

El SDK hena JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar hena mediante programación.
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `hena.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de hena, puede crear una instancia de cliente para conectarse a ella:
