...
1. TUI で `/connect` コマンドを実行し、`Hena Zen` を選択して、[hena.ai/zen](https://hena.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Hena Go` を選択して、[hena.ai/zen](https://hena.ai/zen) にアクセスします。
