...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      HENA_AGENT_EXPERIMENTAL_WORKSPACES: Flag.HENA_AGENT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.HENA_AGENT_EXPERIMENTAL_WORKSPACES = original.HENA_AGENT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
