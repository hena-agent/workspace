 ...
 *   "@hena/ServerAuthConfig",
 *   {
 *     password: Config.string("HENA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("HENA_SERVER_USERNAME").pipe(Config.withDefault("hena")),
 *   },
 * ) {}
 *
