...
import { ListAnchor } from "@hena-agent/schema/session"
...
import { SessionDurable } from "@hena-agent/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/v2/Session") {}
