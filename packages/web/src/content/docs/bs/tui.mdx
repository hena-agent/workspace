---
title: TUI
description: Korištenje korisničkog interfejsa Hena terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Hena pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Hena pokreće TUI za trenutni direktorij.
...
Kada koristite Hena TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Hena. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Hena. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `hena.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Hena čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `hena.default`.
