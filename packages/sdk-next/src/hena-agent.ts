import { HenaAgent } from "@hena-agent/client/effect"
...
import { ApplicationTools } from "@hena-agent/core/tool/application-tools"
import { createEmbeddedRoutes } from "@hena-agent/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("HenaAgent.create")(function* () {
  ...
  const client = yield* HenaAgent.make({ baseUrl: "http://hena-agent.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/sdk-next/HenaAgent") {}
