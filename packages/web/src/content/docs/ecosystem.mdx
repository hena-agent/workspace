...
description: OpenCode projects and integrations compatible with Hena.
---

A collection of community projects built for OpenCode that can be used with Hena through OpenCode compatibility.

:::note
Want to add an OpenCode ecosystem project compatible with Hena to this list? Submit a PR.
:::
