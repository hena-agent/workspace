...
Go fungerer som enhver annen leverandør i Hena. Du abonnerer på Hena Go og
...
Hena Go fungerer som enhver annen leverandør i Hena.
...
[Modell-ID-en](/docs/config/#models) i din Hena-konfigurasjon
bruker formatet `hena-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `hena-go/kimi-k3` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Hena også.
