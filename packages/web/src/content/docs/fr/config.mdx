...
Le fichier de configuration a un schéma défini dans [**`hena.ai/config.json`**](https://hena.ai/config.json).

La configuration TUI utilise [**`hena.ai/tui.json`**](https://hena.ai/tui.json).
