export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.hena-agent.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.hena-agentGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Hena Agentが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Hena Agentで{{provider}}モデルを使用します。",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.hena-agentZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.hena-agentZen.visit.prefix": " ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してHena Agentで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Hena Agentで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "hena-agent.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するHena Agentサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingHenaAgent": "Hena Agentを確認中...",
  "wsl.onboarding.checkingHenaAgentIn": "{{distro}}内のHena Agentを確認中...",
  "wsl.onboarding.updatingHenaAgent": "Hena Agentを更新中...",
  "wsl.onboarding.updatingHenaAgentIn": "{{distro}}内のHena Agentを更新中...",
  "wsl.onboarding.updateHenaAgentIn": "{{distro}}内のHena Agentを更新してください。",
  "wsl.onboarding.updateHenaAgent": "Hena Agentを更新",
  "wsl.onboarding.hena-agentReadyIn": "{{distro}}内のHena Agentの準備ができました。",
  "wsl.onboarding.hena-agentReady": "Hena Agentの準備ができました。",
  "wsl.onboarding.installHenaAgentIn": "{{distro}}にHena Agentをインストールしてください。",
  "wsl.onboarding.installHenaAgent": "Hena Agentをインストール",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agentがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Hena AgentでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Hena Agentをもう一度開いてください。",
  ...
  "toast.update.description": "Hena Agentの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをHena Agentチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (hena-agent.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Hena AgentはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Hena Agentには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でHena Agentサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Hena Agentの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのHena Agentの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Hena Agentがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Hena Agentのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Hena Agent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Hena Agent は最新バージョンです。",
