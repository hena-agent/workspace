export const dict = {
  ...
  "dialog.provider.hena.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.hena.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.henaGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Hena",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Hena.",
  ...
  "provider.connect.henaZen.line1":
    "Hena Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.henaZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.henaZen.visit.prefix": "Відвідайте ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Hena.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в hena.json",
  ...
  "dialog.server.description": "Перемкніть сервер Hena, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingHena": "Перевірка Hena...",
  "wsl.onboarding.checkingHenaIn": "Перевірка Hena у {{distro}}...",
  "wsl.onboarding.updatingHena": "Оновлення Hena...",
  "wsl.onboarding.updatingHenaIn": "Оновлення Hena у {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Оновіть Hena у {{distro}}.",
  "wsl.onboarding.updateHena": "Оновити Hena",
  "wsl.onboarding.henaReadyIn": "Hena готовий до роботи у {{distro}}.",
  "wsl.onboarding.henaReady": "Hena готовий до роботи.",
  "wsl.onboarding.installHenaIn": "Встановіть Hena у {{distro}}.",
  "wsl.onboarding.installHena": "Встановити Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Hena потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Hena не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Hena.",
  ...
  "toast.update.description": "Нова версія Hena ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Hena",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (hena.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Hena ще не підтримує автентифікацію MCP.',
  ...
  "home.project.new": "Новий проєкт",
  "home.project.new.description": "Почніть із чату. Папку можна додати пізніше.",
  "home.project.openFolder": "Відкрити папку",
  "home.project.openFolder.description": "Працюйте в наявній папці.",
  "home.project.name": "Назва проєкту",
  "home.project.create": "Створити проєкт",
  "project.mode.chat": "Чат-проєкт",
  "project.mode.code": "Проєкт коду",
  ...
  "sidebar.gettingStarted.line1": "Hena містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Hena всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Hena",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Hena на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Hena використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Hena.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Hena",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Hena.",
