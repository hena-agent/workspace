...
class Database extends Context.Service<Database, DatabaseShape>()("@hena/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@hena/example/UserStore") {
