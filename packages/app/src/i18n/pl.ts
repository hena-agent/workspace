export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.hena-agent.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.hena-agentGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Hena Agent.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Odwiedź ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Hena Agent.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w hena-agent.json",
  ...
  "dialog.server.description": "Przełącz serwer Hena Agent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Sprawdzanie Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Sprawdzanie Hena Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Aktualizowanie Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Aktualizowanie Hena Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Zaktualizuj Hena Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Zaktualizuj Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent jest gotowy.",
  "wsl.onboarding.installHenaAgentIn": "Zainstaluj Hena Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Zainstaluj Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Hena Agent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Hena Agent.",
  ...
  "toast.update.description": "Nowa wersja Hena Agent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Hena Agent",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (hena-agent.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Hena Agent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Hena Agent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Hena Agent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Hena Agent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Hena Agent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Hena Agent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Hena Agent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Hena Agent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Hena Agent.",
