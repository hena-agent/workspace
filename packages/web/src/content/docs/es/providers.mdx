...
1. Ejecute el comando `/connect` en TUI, seleccione hena-agent y diríjase a [hena.ai/auth](https://hena.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Hena Go` y diríjase a [hena.ai/auth](https://hena.ai/zen).
