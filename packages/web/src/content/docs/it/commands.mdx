...
Crea `.hena-agent/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Hena Agent o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Hena Agent:
...
- Globale: `~/.config/hena-agent/commands/`
- Per progetto: `.hena-agent/commands/`
...
hena-agent include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
