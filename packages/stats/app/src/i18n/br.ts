export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Hena Agent Data",
  "app.description":
    "Explore o uso do Hena Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Hena Agent Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Hena Agent no GitHub",
  "header.github": "GitHub",
  "header.tryHenaAgent": "Experimente o Hena Agent",
  ...
  "footer.homeAria": "Início do Hena Agent",
  ...
  "modal.title": "Newsletter do Hena Agent",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Hena Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Hena Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Hena Agent Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Hena Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Hena Agent.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Hena Agent",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Hena Agent",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Hena Agent nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Hena Agent Data",
  "model.description":
    "Veja dados de uso de {{model}} no Hena Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Hena Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Hena Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Hena Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Hena Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Hena Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Hena Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Hena Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Hena Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Hena Go.",
  ...
  "model.geoDescription": "Tokens do modelo Hena Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Hena Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Hena Go.",
