...
Go funziona come qualsiasi altro provider in Hena. Ti abboni a Hena Go e
...
Hena Go funziona come qualsiasi altro provider in Hena.
...
Il [model id](/docs/config/#models) nella tua Hena config
utilizza il formato `hena-go/<model-id>`. Ad esempio, per Kimi K3, useresti
`hena-go/kimi-k3` nella tua configurazione.
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con Hena.
