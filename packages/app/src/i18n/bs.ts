export const dict = {
  ...
  "dialog.provider.hena.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.hena.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.henaGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Hena",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Hena-u.",
  ...
  "provider.connect.henaZen.visit.prefix": "Posjeti ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Hena-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Hena-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u hena.json",
  ...
  "dialog.server.description": "Promijeni na koji se Hena server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingHena": "Provjera Hena...",
  "wsl.onboarding.checkingHenaIn": "Provjera Hena u distribuciji {{distro}}...",
  "wsl.onboarding.updatingHena": "Ažuriranje Hena...",
  "wsl.onboarding.updatingHenaIn": "Ažuriranje Hena u distribuciji {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Ažuriraj Hena u distribuciji {{distro}}.",
  "wsl.onboarding.updateHena": "Ažuriraj Hena",
  "wsl.onboarding.henaReadyIn": "Hena je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.henaReady": "Hena je spreman.",
  "wsl.onboarding.installHenaIn": "Instaliraj Hena u distribuciji {{distro}}.",
  "wsl.onboarding.installHena": "Instaliraj Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Hena mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Hena nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Hena.",
  ...
  "toast.update.description": "Nova verzija Hena-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Hena timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (hena.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Hena još ne podržava MCP autentifikaciju.',
  ...
  "home.project.new": "Novi projekat",
  "home.project.new.description": "Počnite razgovorom. Dodajte mapu kasnije.",
  "home.project.openFolder": "Otvori mapu",
  ...
  "sidebar.gettingStarted.line1": "Hena uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Hena server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Hena-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Hena izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Hena prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Hena-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Hena pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Hena-a.",
