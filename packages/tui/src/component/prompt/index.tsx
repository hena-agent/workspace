...
import { registerHenaSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@hena/sdk/v2"
...
import { HENA_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useHenaKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.HENA_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
