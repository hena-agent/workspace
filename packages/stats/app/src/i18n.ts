...
const en = {
  "app.title": "AI Model Usage Rankings | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Hena Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Hena on GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Try Hena",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent Hena usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Hena",
  ...
  "lab.shareOfUsage": "{{share}} of recent Hena usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Hena Data",
  "model.description":
