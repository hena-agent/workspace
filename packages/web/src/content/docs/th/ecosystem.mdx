---
title: ระบบนิเวศ OpenCode
description: โปรเจ็กต์และการผสานรวม OpenCode ที่เข้ากันได้กับ Hena
---

ชุดโครงการชุมชนที่สร้างขึ้นสำหรับ OpenCode และใช้กับ Hena ได้ผ่านความเข้ากันได้กับ OpenCode

:::note
ต้องการเพิ่มโครงการในระบบนิเวศ OpenCode ที่เข้ากันได้กับ Hena ลงในรายการนี้หรือไม่ ส่งพีอาร์.
:::
