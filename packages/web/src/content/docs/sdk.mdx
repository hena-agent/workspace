---
title: SDK
description: Type-safe JS client for hena-agent server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The hena-agent JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control hena-agent programmatically.
...
Create an instance of hena-agent:
...
You can pass a configuration object to customize behavior. The instance still picks up your `hena-agent.json`, but you can override or add configuration inline:
...
If you already have a running instance of hena-agent, you can create a client instance to connect to it:
