...
Practical reference for the current tool-migration state in `packages/hena`.
...
Tool tests should use the existing Effect helpers in `packages/hena/test/lib/effect.ts`:
