...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite hena-agent i idite na [hena.ai/auth](https://hena.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Hena Go` i idite na [hena.ai/auth](https://hena.ai/zen).
