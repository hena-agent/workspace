import type { Session as SDKSession, Message, Part } from "@hena-agent/sdk/v2"
...
import { SessionTable, MessageTable, PartTable } from "@hena-agent/core/session/sql"
...
/** Extract share ID from a share URL like https://hena.dev/share/abc123 */
