...
import { openEditor } from "@hena-agent/tui/editor"
import { registerHenaAgentKeymap } from "@hena-agent/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerHenaAgentKeymap(keymap, renderer, input.tuiConfig)
