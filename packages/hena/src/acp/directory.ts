...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@hena/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@hena/ACPDirectory") {}
