export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.hena-agent.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.hena-agentGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Hena Agent.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Besøg ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Hena Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Hena Agent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i hena-agent.json",
  ...
  "dialog.server.description": "Skift hvilken Hena Agent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Tjekker Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Tjekker Hena Agent i {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Opdaterer Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Opdaterer Hena Agent i {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Opdater Hena Agent i {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Opdater Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Hena Agent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Hena Agent igen.",
  ...
  "toast.update.description": "En ny version af Hena Agent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Hena Agent-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (hena-agent.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Hena Agent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Hena Agent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Hena Agent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Hena Agent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Hena Agent følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Hena Agent er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Hena Agent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Hena Agent.",
