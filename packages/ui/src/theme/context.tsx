...
const STORAGE_KEYS = {
  THEME_ID: "hena-agent-theme-id",
  COLOR_SCHEME: "hena-agent-color-scheme",
  THEME_CSS_LIGHT: "hena-agent-theme-css-light",
  THEME_CSS_DARK: "hena-agent-theme-css-dark",
} as const
