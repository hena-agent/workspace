...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@hena/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@hena/ToolRegistry") {}
