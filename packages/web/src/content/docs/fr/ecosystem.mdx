---
title: Écosystème OpenCode
description: Projets et intégrations OpenCode compatibles avec Hena.
---

Une collection de projets communautaires conçus pour OpenCode et utilisables avec Hena grâce à la compatibilité OpenCode.

:::note
Vous souhaitez ajouter à cette liste un projet de l'écosystème OpenCode compatible avec Hena ? Soumettez une PR.
:::
