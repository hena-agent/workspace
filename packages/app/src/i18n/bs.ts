export const dict = {
  ...
  "dialog.provider.hena-agent.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.hena-agent.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.hena-agentGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Hena Agent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Hena Agent-u.",
  ...
  "provider.connect.hena-agentZen.line1":
    "Hena Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.hena-agentZen.visit.prefix": "Posjeti ",
  "provider.connect.hena-agentZen.visit.link": "hena.ai/zen",
  "provider.connect.hena-agentZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Hena Agent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Hena Agent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u hena-agent.json",
  ...
  "dialog.server.description": "Promijeni na koji se Hena Agent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingHenaAgent": "Provjera Hena Agent...",
  "wsl.onboarding.checkingHenaAgentIn": "Provjera Hena Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingHenaAgent": "Ažuriranje Hena Agent...",
  "wsl.onboarding.updatingHenaAgentIn": "Ažuriranje Hena Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updateHenaAgentIn": "Ažuriraj Hena Agent u distribuciji {{distro}}.",
  "wsl.onboarding.updateHenaAgent": "Ažuriraj Hena Agent",
  "wsl.onboarding.hena-agentReadyIn": "Hena Agent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.hena-agentReady": "Hena Agent je spreman.",
  "wsl.onboarding.installHenaAgentIn": "Instaliraj Hena Agent u distribuciji {{distro}}.",
  "wsl.onboarding.installHenaAgent": "Instaliraj Hena Agent",
  ...
  "wsl.onboarding.distroStatus.hena-agentMissing": "Hena Agent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Hena Agent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Hena Agent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Hena Agent.",
  ...
  "toast.update.description": "Nova verzija Hena Agent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Hena Agent timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (hena-agent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Hena Agent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Hena Agent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Hena Agent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Hena Agent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Hena Agent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Hena Agent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Hena Agent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Hena Agent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Hena Agent-a.",
