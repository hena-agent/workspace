...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@hena-agent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@hena-agent/ACPDirectory") {}
