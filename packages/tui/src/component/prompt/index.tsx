...
import { registerHenaAgentSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@hena-agent/sdk/v2"
...
import { HENA_AGENT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useHenaAgentKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.HENA_AGENT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
