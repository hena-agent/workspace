...
1. Kjør kommandoen `/connect` i TUI, velg `Hena Zen` og gå til [hena.ai/auth](https://hena.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Hena Go`, og gå til [hena.ai/auth](https://hena.ai/zen).
