...
- PR #15835: https://github.com/hena-agent/hena/pull/15835

## Do Not Translate (Locale Additions)

- `Hena Agent` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `hena-agent` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Hena Agent` in prose, `hena-agent` only for exact technical identifiers
...
- Avoid changing `hena-agent` to `Hena Agent` inside commands, URLs, package names, or code literals
