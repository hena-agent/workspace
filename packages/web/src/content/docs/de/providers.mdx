...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie Hena Agent aus und gehen Sie zu [hena.ai/auth](https://hena.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `Hena Go` und gehen Sie zu [hena.ai/auth](https://hena.ai/zen).
