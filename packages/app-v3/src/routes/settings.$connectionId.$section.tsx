...
import { listConnections, listMcpServers, listModels, listProviders } from "@/mock/queries"
  ...
  return (
    <ServerSettingsView
      ...
      onSelectSection={(next) =>
        void navigate({ to: "/settings/$connectionId/$section", params: { connectionId, section: next } })
      }
      providers={providers}
