---
title: Paylasim
description: hena konusmalarini genel baglantilarla paylasin.
---

hena'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda hena:
...
hena, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak hena manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `hena.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda hena kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
