---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor Hena Agent.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK hena-agent JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar hena-agent mediante programación.
...
Cree una instancia de hena-agent:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `hena-agent.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de hena-agent, puede crear una instancia de cliente para conectarse a ella:
