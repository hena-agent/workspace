---
title: Økosystem
description: Projekter og integrationer bygget med Hena Agent.
---

En samling af samfundsprojekter bygget på Hena Agent.

:::note
Vil du tilføje dit Hena Agent-relaterede projekt til denne liste? Send en PR.
:::
...
| Navn                                                                                               | Beskrivelse                                                                                                       |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kør automatisk Hena Agent-sessioner i isolerede Daytona-sandkasser med git-synkronisering og live forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Hena Agent brug med Wakatime                                                                                   |
...
| [oh-my-hena-agent](https://github.com/code-yeongyu/oh-my-hena-agent)                                   | Baggrundsagenter, præbyggede LSP/AST/MCP værktøjer, kuraterede agenter, Claude Kodekompatibel                     |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsmeddelelser og lydadvarsler for Hena Agent-sessioner                                                     |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sessionsnavngivning baseret på Hena Agent-kontekst                                      |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillad Hena Agent-agenter til dovne load-prompter på efterspørgsel med færdighedsopdagelse og -injektion            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Udvid hena-agent /commands til et kraftfuldt orkestreringssystem med granulær flowkontrol                           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-meddelelser for Hena Agent – ved, hvornår opgaver er fuldført                                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nulfriktions git-arbejdstræer for Hena Agent                                                                        |
...
| Navn                                                                                       | Beskrivelse                                                            |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot til at styre Hena Agent-sessioner, bygget på SDK             |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin til redaktør-bevidste prompter, bygget på API            |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI til Hena Agent over Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Skabelon til at bygge Hena Agent plugins                                 |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-frontend til hena-agent - en terminalbaseret AI-kodningsagent     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK udbyder til brug af Hena Agent via @hena-agent/sdk        |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App og VS Code udvidelse til Hena Agent                    |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin, der integrerer Hena Agent i Obsidians brugergrænseflade |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et open source-alternativ til Claude Cowork, drevet af Hena Agent        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hena Agent udvidelsesmanager med bærbare, isolerede profiler.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, web-, mobil- og fjernklientapp til Hena Agent                  |
