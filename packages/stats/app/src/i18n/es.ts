export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo textual de Hena Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Hena en GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Probar Hena",
  ...
  "footer.homeAria": "Inicio de Hena",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Hena.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Hena",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Hena",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Hena durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Hena Data",
  "model.description":
