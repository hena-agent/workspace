...
import { MAX_STEPS_PROMPT } from "@hena-agent/core/session/runner/max-steps"
...
import { LLMEvent } from "@hena-agent/llm"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/SessionPrompt") {}
