...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/hena-agent/hena.git")).toEqual({ owner: "hena-agent", repo: "hena" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/hena-agent/hena")).toEqual({ owner: "hena-agent", repo: "hena" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:hena-agent/hena.git")).toEqual({ owner: "hena-agent", repo: "hena" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:hena-agent/hena")).toEqual({ owner: "hena-agent", repo: "hena" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/hena-agent/hena.git")).toEqual({ owner: "hena-agent", repo: "hena" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/hena-agent/hena")).toEqual({ owner: "hena-agent", repo: "hena" })
})
