...
import { Event } from "@hena/schema/project-directories"
import { ProjectCopy } from "@hena/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@hena/ProjectCopy") {}
