...
export const TypeId: TypeId = "~@hena-agent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@hena-agent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@hena-agent/effect-sqlite-node/NodeSqliteClient")
