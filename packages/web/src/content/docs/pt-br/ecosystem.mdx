---
title: Ecossistema OpenCode
description: Projetos e integrações OpenCode compatíveis com o Hena.
---

Uma coleção de projetos da comunidade criados para o OpenCode que podem ser usados com o Hena por meio da compatibilidade com o OpenCode.

:::note
Quer adicionar a esta lista um projeto do ecossistema OpenCode compatível com o Hena? Envie um PR.
:::
