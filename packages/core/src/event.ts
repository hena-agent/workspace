...
import type { Data, Definition, Payload } from "@hena-agent/schema/event"
...
import { Durable } from "@hena-agent/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@hena-agent/schema/event").ID
export type { Data, Definition, Payload } from "@hena-agent/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/Event") {}
