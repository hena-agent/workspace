...
process.env["HENA_TEST_HOME"] = testHome

// Set test managed config directory to isolate tests from system managed settings
const testManagedConfigDir = path.join(dir, "managed")
process.env["HENA_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "hena")
...
delete process.env["HENA_SERVER_USERNAME"]
delete process.env["HENA_EXPERIMENTAL"]
delete process.env["HENA_ENABLE_EXPERIMENTAL_MODELS"]
