...
class Database extends Context.Service<Database, DatabaseShape>()("@hena-agent/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@hena-agent/example/UserStore") {
