...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips hena-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-hena-directory"]).toBeUndefined()
      expect(forwarded["x-hena-workspace"]).toBeUndefined()
