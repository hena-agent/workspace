...
Agentferdigheter lar Hena Agent oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går hena-agent opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
hena-agent viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `hena-agent.json`:
