...
import { HenaAgent, isSessionNotFoundError, isUnauthorizedError } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = HenaAgent.make({ baseUrl: "http://localhost:3000" })
