...
Il file di configurazione ha uno schema definito in [**`hena.ai/config.json`**](https://hena.ai/config.json).

La configurazione TUI usa [**`hena.ai/tui.json`**](https://hena.ai/tui.json).
