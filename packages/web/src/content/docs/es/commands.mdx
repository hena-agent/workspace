...
Crear `.hena-agent/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Hena Agent o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Hena Agent [config](/docs/config):
...
- Por proyecto: `.hena-agent/commands/`
...
hena-agent incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
