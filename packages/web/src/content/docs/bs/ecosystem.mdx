---
title: Ekosistem
description: Projekti i integracije izgrađeni uz Hena Agent.
---

Kolekcija projekata zajednice izgrađenih na Hena Agent.

:::note
Želite li na ovu listu dodati svoj Hena Agent projekat? Pošaljite PR.
:::
...
| Ime                                                                                                | Opis                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatski pokrenite Hena Agent sesije u izoliranim Daytona sandboxovima uz git sinhronizaciju i preglede uživo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Pratite upotrebu Hena Agent sa Wakatime                                                                         |
...
| [oh-my-hena-agent](https://github.com/code-yeongyu/oh-my-hena-agent)                                   | Pozadinski agenti, unapred izgrađeni LSP/AST/MCP alati, kurirani agenti, kompatibilni sa Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Obavještenja na radnoj površini i zvučna upozorenja za Hena Agent sesije                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatsko imenovanje Zellij sesije na bazi Hena Agent konteksta                                                |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Dozvolite Hena Agent agentima da lijeno učitavaju upite na zahtjev uz otkrivanje vještina i ubrizgavanje        |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite hena-agent /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifikacije izvornog OS-a za Hena Agent – znajte kada se zadaci dovrše                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git radna stabla bez trenja za Hena Agent                                                                       |
...
| Ime                                                                                        | Opis                                                                  |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot za kontrolu Hena Agent sesija, izgrađen na SDK              |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim dodatak za upite svjestan uređivača, izgrađen na API           |
| [portal](https://github.com/hosenur/portal)                                                | Mobilni korisnički interfejs za Hena Agent preko Tailscale/VPN          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju Hena Agent dodataka                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend za hena-agent - terminal baziran AI agent za kodiranje  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK dobavljač za korištenje Hena Agent putem @hena-agent/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App i VS Code Extension za Hena Agent                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian dodatak koji ugrađuje Hena Agent u Obsidian-ov UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću Hena Agent |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hena Agent menadžer ekstenzija sa prenosivim, izolovanim profilima.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile i Remote Client aplikacija za Hena Agent           |
