...
import { Event } from "@hena-agent/schema/project-directories"
import { ProjectCopy } from "@hena-agent/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@hena-agent/ProjectCopy") {}
