...
export const dict = {
  ...
  "dialog.provider.hena.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.hena.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.henaGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Hena",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Hena zu nutzen.",
  ...
  "provider.connect.henaZen.line1":
    "Hena Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.henaZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Hena zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Hena zu nutzen.",
  ...
  "dialog.plugins.empty": "In hena.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Hena-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingHena": "Hena wird geprüft...",
  "wsl.onboarding.checkingHenaIn": "Hena in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingHena": "Hena wird aktualisiert...",
  "wsl.onboarding.updatingHenaIn": "Hena in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateHenaIn": "Aktualisieren Sie Hena in {{distro}}.",
  "wsl.onboarding.updateHena": "Hena aktualisieren",
  "wsl.onboarding.henaReadyIn": "Hena ist in {{distro}} bereit.",
  "wsl.onboarding.henaReady": "Hena ist bereit.",
  "wsl.onboarding.installHenaIn": "Installieren Sie Hena in {{distro}}.",
  "wsl.onboarding.installHena": "Hena installieren",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Hena einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Hena konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Hena erneut.",
  ...
  "toast.update.description": "Eine neue Version von Hena ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Hena-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (hena.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Hena unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.project.new": "Neues Projekt",
  "home.project.new.description": "Mit einem Chat beginnen. Einen Ordner später hinzufügen.",
  "home.project.openFolder": "Ordner öffnen",
  "home.project.openFolder.description": "In einem vorhandenen Ordner arbeiten.",
  "home.project.name": "Projektname",
  "home.project.create": "Projekt erstellen",
  "project.mode.chat": "Chat-Projekt",
  "project.mode.code": "Code-Projekt",
  ...
  "sidebar.gettingStarted.line1": "Hena enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Hena-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Hena ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Hena auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Hena dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Hena anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Hena automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Hena.",
