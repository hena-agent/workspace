---
title: Ecosistema OpenCode
description: Progetti e integrazioni OpenCode compatibili con Hena.
---

Una raccolta di progetti della comunità creati per OpenCode che possono essere usati con Hena grazie alla compatibilità con OpenCode.

:::note
Vuoi aggiungere a questa lista un progetto dell'ecosistema OpenCode compatibile con Hena? Apri una PR.
:::
