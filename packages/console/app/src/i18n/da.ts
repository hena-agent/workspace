...
export const dict = {
  ...
  "go.title": "Hena Go | Kodningsmodeller til lav pris for alle",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampagne for {{model}} er afsluttet. Du kan fortsætte med at bruge modellen ved at abonnere på Hena Go - {{link}}",

  "black.meta.title": "Hena Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med Hena Black-abonnementer.",
  ...
  "black.workspace.title": "Hena Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på Hena Black-ventelisten",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Hena Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned Hena Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned Hena Black plan.",
  ...
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på Hena Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på Hena Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "Hena Go starter ved {{price}}, derefter $10/måned, og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
