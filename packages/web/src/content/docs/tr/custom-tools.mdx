---
title: Özel Araçlar
description: LLM'un hena'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. hena'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.hena/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/hena/tools/` içine yerleştirerek.
