...
O Go funciona como qualquer outro provedor no Hena. Você assina o Hena Go e
...
O Hena Go funciona como qualquer outro provedor no Hena.
...
O [ID do modelo](/docs/config/#models) na sua configuração do Hena
usa o formato `hena-go/<model-id>`. Por exemplo, para o Kimi K3, você usaria
`hena-go/kimi-k3` na sua configuração.
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o Hena também.
