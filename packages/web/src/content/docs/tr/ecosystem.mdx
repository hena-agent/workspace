---
title: OpenCode Ekosistemi
description: Hena ile uyumlu OpenCode projeleri ve entegrasyonları.
---

OpenCode için geliştirilmiş ve OpenCode uyumluluğu sayesinde Hena ile kullanılabilen topluluk projeleri koleksiyonu.

:::note
Hena ile uyumlu OpenCode ekosistemi projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::
