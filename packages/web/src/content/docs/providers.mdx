...
1. Run the `/connect` command in the TUI, select `Hena Zen`, and head to [hena.ai/auth](https://hena.ai/zen).
...
1. Run the `/connect` command in the TUI, select `Hena Go`, and head to [hena.ai/auth](https://hena.ai/zen).
