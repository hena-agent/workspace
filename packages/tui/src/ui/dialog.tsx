...
import { useBindings, useHenaModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useHenaModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.HENA_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
