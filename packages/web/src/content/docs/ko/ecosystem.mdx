---
title: OpenCode 생태계
description: Hena와 호환되는 OpenCode 프로젝트와 통합.
---

OpenCode용으로 만들어졌으며 OpenCode 호환성을 통해 Hena에서도 사용할 수 있는 커뮤니티 프로젝트 모음입니다.

:::note
Hena와 호환되는 OpenCode 생태계 프로젝트를 이 목록에 추가하고 싶다면 PR을 제출하세요.
:::
