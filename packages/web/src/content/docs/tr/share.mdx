---
title: Paylasim
description: hena-agent konusmalarini genel baglantilarla paylasin.
---

hena-agent'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda hena-agent:

1. Oturumunuz icin benzersiz bir genel URL olusturur
2. Konusma gecmisinizi sunucularimiza senkronize eder
3. Konusmayi paylasim baglantisiyla erisilebilir hale getirir - `hena.dev/s/<share-id>`

---

## Paylasim

hena-agent, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak hena-agent manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `hena-agent.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda hena-agent kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
