...
import { useBindings, useHenaAgentModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useHenaAgentModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.HENA_AGENT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
