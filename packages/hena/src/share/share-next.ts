...
import type * as SDK from "@hena/sdk/v2"
...
import { SessionShareTable } from "@hena/core/share/sql"
import { ProviderV2 } from "@hena/core/provider"
import { ModelV2 } from "@hena/core/model"
import { EventV2 } from "@hena/core/event"

const disabled = process.env["HENA_DISABLE_SHARE"] === "true" || process.env["HENA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@hena/ShareNext") {}
