export const dict = {
  ...
  "dialog.provider.hena.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.hena.tagline": "Modelos optimizados y fiables",
  "dialog.provider.henaGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Hena",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Hena.",
  ...
  "provider.connect.henaZen.line1":
    "Hena Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.henaZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.henaZen.visit.prefix": "Visita ",
  "provider.connect.henaZen.visit.link": "hena.dev/zen",
  "provider.connect.henaZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Hena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Hena.",
  ...
  "dialog.plugins.empty": "Plugins configurados en hena.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Hena se conecta esta app.",
  ...
  "wsl.onboarding.checkingHena": "Comprobando Hena...",
  "wsl.onboarding.checkingHenaIn": "Comprobando Hena en {{distro}}...",
  "wsl.onboarding.updatingHena": "Actualizando Hena...",
  "wsl.onboarding.updatingHenaIn": "Actualizando Hena en {{distro}}...",
  "wsl.onboarding.updateHenaIn": "Actualiza Hena en {{distro}}.",
  "wsl.onboarding.updateHena": "Actualizar Hena",
  "wsl.onboarding.henaReadyIn": "Hena está listo en {{distro}}.",
  "wsl.onboarding.henaReady": "Hena está listo.",
  "wsl.onboarding.installHenaIn": "Instala Hena en {{distro}}.",
  "wsl.onboarding.installHena": "Instalar Hena",
  ...
  "wsl.onboarding.distroStatus.henaMissing": "Hena no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Hena pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Hena no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Hena.",
  ...
  "toast.update.description": "Una nueva versión de Hena ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Hena",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (hena.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Hena no soporta autenticación MCP todavía.',
  ...
  "home.project.new": "Nuevo proyecto",
  "home.project.new.description": "Empieza con un chat. Añade una carpeta más tarde.",
  "home.project.openFolder": "Abrir carpeta",
  "home.project.openFolder.description": "Trabaja en una carpeta existente.",
  "home.project.name": "Nombre del proyecto",
  "home.project.create": "Crear proyecto",
  "project.mode.chat": "Proyecto de chat",
  "project.mode.code": "Proyecto de código",
  ...
  "sidebar.gettingStarted.line1": "Hena incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Hena dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Hena",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Hena en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Hena sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Hena.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Hena",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Hena.",
