...
import { IconHena } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "hena/session/message-v2"
import type { Message } from "hena/session/message"
import type { Session } from "hena/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.henaVersion} data-slot="item">
                  <div data-slot="icon" title={props.messages.henaName}>
                    <IconHena width={16} height={16} />
                  </div>
