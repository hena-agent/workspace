...
type Endpoint3_6Input = {
  ...
  readonly selection?: Endpoint3_6Request["payload"]["selection"]
...
type Endpoint3_12Request = Parameters<RawClient["server.session"]["session.revert.replace"]>[0]
