---
title: Экосистема OpenCode
description: Проекты и интеграции OpenCode, совместимые с Hena.
---

Коллекция проектов сообщества, созданных для OpenCode и доступных в Hena благодаря совместимости с OpenCode.

:::note
Хотите добавить в этот список проект экосистемы OpenCode, совместимый с Hena? Разместите PR.
:::
