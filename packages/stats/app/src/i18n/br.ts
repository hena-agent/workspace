export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Hena Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do Hena Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Hena no GitHub",
  "header.github": "GitHub",
  "header.tryHena": "Experimente o Hena",
  ...
  "footer.homeAria": "Início do Hena",
  ...
  "modal.title": "Newsletter do Hena",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Hena Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Hena.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Hena",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Hena",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Hena nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Hena Data",
  "model.description":
